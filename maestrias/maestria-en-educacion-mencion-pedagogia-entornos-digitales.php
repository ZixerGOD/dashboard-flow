...
<body class="home page-template-default page page-id-2039 gdlr-core-body woocommerce-no-js tribe-no-js kingster-body kingster-body-front kingster-full  kingster-with-sticky-navigation  kingster-blockquote-style-1 gdlr-core-link-to-lightbox">
   ...
   <div class="kingster-body-outer-wrapper ">
      <div class="kingster-body-wrapper clearfix  kingster-with-frame">
         ...
         <div class="kingster-page-title-wrap  kingster-style-custom kingster-left-align" style="background-image: url(../images/carreras/maestria-en-educacion-mencion-pedagogia-entornos-digitales-top.png) ;">
            ...
            <div class="kingster-page-title-container kingster-container">
               <div class="kingster-page-title-content kingster-item-pdlr" style="padding-top: 200px ;padding-bottom: 80px ;">
                  ...
                  <h1 class="kingster-page-title" style="text-transform: none ;">Maestr&iacute;a en Educación, Menci&oacute;n en Pedagog&iacute;a en Entornos Digitales</h1>
               </div>
            </div>
         </div>
                           ...
                           <div class="gdlr-core-pbf-element" style="background-color:#800f34;">
                              <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix  gdlr-core-center-align gdlr-core-title-item-caption-top gdlr-core-item-pdlr" style="padding-bottom: 15px; padding-top:15px;">
                                 <div class="gdlr-core-title-item-title-wrap clearfix">
                                    ...
                                    <h3 class="gdlr-core-title-item-title gdlr-core-skin-title " style="font-size: 18px ;font-weight: 600 ;letter-spacing: 0px ;text-transform: none ;color: #ffffff;margin-right: 30px;">Inauguración: Abril 20, 2026</h3>                                    
                                 </div>
                              </div>
                           </div>
                           ...
                           <div class="gdlr-core-pbf-element">
                              <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align">
                                 <div class="gdlr-core-text-box-item-content" style="font-size: 16px ;text-transform: none ;">
                                    <p>La Maestría en Educación con mención en Pedagogía en Entornos Digitales 100% en línea esta dirigida a
                                       profesionales de tercer nivel de grado en el campo de la educación y docentes de otras áreas del
                                       conocimiento que justifiquen su actividad laboral en el ejercicio de la docencia. , que quieran profundizar sus
                                       conocimientos en la gestión de innovaciones pedagógicas, para la gestión de los entornos digitales
                                       basados en las nuevas tendencias educativas. 

                                    </p>
                                    <p><strong>Duraci&oacute;n De Programa:</strong> 12 Meses</p>
                                    <p><strong>Tutorías sincrónicas: </strong> Sábado o domingo de 08h00 a 13h00 </p>
                                          ...
                                          <div class="gdlr-core-column-service-item gdlr-core-item-pdb  gdlr-core-left-align gdlr-core-column-service-icon-left gdlr-core-with-caption gdlr-core-item-pdlr" style="padding-bottom: 30px;">
                                             ...
                                             <div class="gdlr-core-column-service-content-wrapper">
                                                <div class="gdlr-core-column-service-title-wrap">
                                                   ...
                                                   <div class="gdlr-core-column-service-caption gdlr-core-info-font gdlr-core-skin-caption" style="font-size: 15px ;font-weight: 500 ;font-style: normal ;">Magíster en Educación, mención Pedagogía en Entornos Digitales, Universidad Espíritu Santo, Ecuador.</div>
                                          ...
                                          <div class="gdlr-core-column-service-item gdlr-core-item-pdb  gdlr-core-left-align gdlr-core-column-service-icon-left gdlr-core-with-caption gdlr-core-item-pdlr" style="padding-bottom: 30px;">
                                             ...
                                             <div class="gdlr-core-column-service-content-wrapper">
                                                <div class="gdlr-core-column-service-title-wrap">
                                                   ...
                                                   <div class="gdlr-core-column-service-caption gdlr-core-info-font gdlr-core-skin-caption" style="font-size: 15px ;font-weight: 500 ;font-style: normal ;">RPC-SO-04-No.079-2023</div>
                                                </div>
                                             </div>
                                          </div>
                                       </div>
                              ...
                              <div class="textwidget" style="box-shadow: 0 -6px 24px rgba(10, 10, 10,0.09); -moz-box-shadow: 0 -6px 24px rgba(10, 10, 10,0.09); -webkit-box-shadow: 0 -6px 24px rgba(10, 10, 10,0.09); background-color: #ffffff ;border-radius:  3px 3px ;-moz-border-radius:  3px 3px ;-webkit-border-radius:  3px 3px ;">
                                 <div class="gdlr-core-widget-box-shortcode " style="color: #821436 ;padding: 25px 5px;background-color: #ffffff ;">
                                    <div class="gdlr-core-widget-box-shortcode-content">
                                       ...
                                       <div class="gdlr-core-pbf-element">
                                          <div id="form-83521"></div>
                                          <script src="https://webservices.uees.edu.ec/formularios/v2/form-embed.js" data-programa-id="835" data-nivel-id="2" data-modalidad-id="1" data-height="900" data-container="form-83521" defer></script>
                                       </div>
                                    </div>
                                 </div>
                              </div>
                              ...
                              <div class="gdlr-core-pbf-element">
                                 <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align">
                                    <div class="gdlr-core-text-box-item-content" style="font-size: 17px ;text-transform: none ;">
                                       <p>Formar profesionales competentes en la gestión de innovaciones pedagógicas ajustadas a los
                                          requerimientos de la educación en línea, haciendo uso de los entornos digitales basados en las nuevas
                        ...
                        <div class="gdlr-core-pbf-column-content-margin gdlr-core-js " style="padding: 100px 40px 50px 10px; height: 653.976px;" data-sync-height="height-1" data-sync-height-center="">
                           ...
                           <div class="gdlr-core-pbf-column-content clearfix gdlr-core-js  gdlr-core-sync-height-content">
                              ...
                              <div class="gdlr-core-pbf-element">
                                 <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align">
                                    <div class="gdlr-core-text-box-item-content" style="font-size: 17px ;text-transform: none ;">
                                       <p>El estudiante egresado contará con las competencias requeridas para su desempeño como docente en
                                          todos los niveles educativos, haciendo uso de las habilidades pedagógicas al aplicar los recursos de los
                                          entornos virtuales para la enseñanza y el aprendizaje, en el marco de procesos investigativos que
                                          coadyuven en la solución de distintas problemáticas asociadas a los procesos de enseñanza y aprendizaje,
                                          utilizando para ello métodos innovadores asociados a las tendencias educativas actuales, en medio del
                                          desarrollo de valores altamente significativos para la labor docente.
                                       </p>
                                    </div>
                                 </div>
                              </div>
                              ...
                              <div class="gdlr-core-pbf-element">
                                 <table>
                                    ...
                                    <tr style="background-color: #ffffff">
                                       <td>Gestión del tiempo y habilidades interpersonales</td>
                                       <td>18</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                       <td>Teoría y Modelos Innovadores de Organización Curricular </td>
                                       <td>18</td>
                                    </tr>
                                    <tr>
                                       <td>Entornos Digitales y Transmedia</td>
                                       <td>18</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                       <td>Sistema Educativo, políticas y Legislación</td>
                                       <td>18</td>
                                    </tr>
                                    <tr>
                                       <td>Didáctica de la Gamificación y la Narrativa Transmedia</td>
                                       <td>24</td>
                                    </tr>
                                    <tr>
                                       <td>Creatividad y Desarrollo del Talento Humano</td>
                                       <td>18</td>
                                    </tr>
                                    <tr>
                                       <td>Tecnologías para la Educación Inclusiva</td>
                                       <td>24</td>
                                    </tr>
                                    <tr>
                                       <td>Titulación II: Informe de Investigación</td>
                                       <td>24</td>
                                    </tr>
