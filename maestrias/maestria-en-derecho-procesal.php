...
<body class="home page-template-default page page-id-2039 gdlr-core-body woocommerce-no-js tribe-no-js kingster-body kingster-body-front kingster-full  kingster-with-sticky-navigation  kingster-blockquote-style-1 gdlr-core-link-to-lightbox">
   ...
   <div class="kingster-body-outer-wrapper ">
      <div class="kingster-body-wrapper clearfix  kingster-with-frame">
         ...
         <div class="kingster-page-title-wrap  kingster-style-custom kingster-left-align" style="background-image: url(../images/carreras/maestria-en-derecho-procesal-top.jpg) ;">
            ...
            <div class="kingster-page-title-container kingster-container">
               <div class="kingster-page-title-content kingster-item-pdlr" style="padding-top: 200px ;padding-bottom: 80px ;">
                  ...
                  <h1 class="kingster-page-title" style="text-transform: none ;">Maestr&iacute;a en Derecho Procesal</h1>
               </div>
            </div>
         </div>
                           ...
                           <div class="gdlr-core-pbf-element" style="background-color:#800f34;">
                              <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix  gdlr-core-center-align gdlr-core-title-item-caption-top gdlr-core-item-pdlr" style="padding-bottom: 15px; padding-top:15px;">
                                 <div class="gdlr-core-title-item-title-wrap clearfix">
                                    <h3 class="gdlr-core-title-item-title gdlr-core-skin-title " style="font-size: 26px ;font-weight: 600 ;letter-spacing: 0px ;text-transform: none ;color: #ffffff;margin-right: 30px;">Inauguración: <?php echo obtenerFechaInauguracion("Maestria en Derecho Procesal OnLine");?></h3>
                                 </div>
                              </div>
                           </div>
                           ...
                           <div class="gdlr-core-pbf-element">
                              <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align">
                                 <div class="gdlr-core-text-box-item-content" style="font-size: 16px ;text-transform: none ;">
                                    <p>La Maestría en Derecho Procesal 100% en línea está dirigida a profesionales del derecho con título de tercer nivel, debidamente inscrito en el SENESCYT.</p>
                                          ...
                                          <div class="gdlr-core-column-service-item gdlr-core-item-pdb  gdlr-core-left-align gdlr-core-column-service-icon-left gdlr-core-with-caption gdlr-core-item-pdlr" style="padding-bottom: 30px;">
                                             ...
                                             <div class="gdlr-core-column-service-content-wrapper">
                                                <div class="gdlr-core-column-service-title-wrap">
                                                   ...
                                                   <div class="gdlr-core-column-service-caption gdlr-core-info-font gdlr-core-skin-caption" style="font-size: 15px ;font-weight: 500 ;font-style: normal ;">Mag&iacute;ster en Derecho Procesal</div>
                                                </div>
                                             </div>
                                          </div>
                                       </div>
                              ...
                              <div class="textwidget" style="box-shadow: 0 -6px 24px rgba(10, 10, 10,0.09); -moz-box-shadow: 0 -6px 24px rgba(10, 10, 10,0.09); -webkit-box-shadow: 0 -6px 24px rgba(10, 10, 10,0.09); background-color: #ffffff ;border-radius:  3px 3px ;-moz-border-radius:  3px 3px ;-webkit-border-radius:  3px 3px ;">
                                 <div class="gdlr-core-widget-box-shortcode " style="color: #821436 ;padding: 25px 5px;background-color: #ffffff ;">
                                    <div class="gdlr-core-widget-box-shortcode-content">
                                       ...
                                       <div class="gdlr-core-pbf-element">
                                          <div id="form-73521"></div>
                                          <script src="https://webservices.uees.edu.ec/formularios/v2/form-embed.js" data-programa-id="735" data-nivel-id="2" data-modalidad-id="1" data-height="900" data-container="form-73521" defer></script>
                                       </div>
                                    </div>
                                 </div>
                              </div>
                     ...
                     <div class="gdlr-core-pbf-column gdlr-core-column-30 gdlr-core-column-first" id="gdlr-core-column-8638">
                        <div class="gdlr-core-pbf-column-content-margin gdlr-core-js  gdlr-core-column-extend-left" data-sync-height="height-2" style="height: 860.461px;">
                           <div class="gdlr-core-pbf-background-wrap">
                              <div class="gdlr-core-pbf-background gdlr-core-parallax gdlr-core-js" style="background-image: url(../images/carreras/maestrias-derecho-05.jpg); background-size: cover; background-position: center center; height: 875.969px; transform: translate(0px, -43.5328px);" data-parallax-speed="0.2"></div>
                           </div>
                              ...
                              <div class="gdlr-core-pbf-element">
                                 <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align">
                                    <div class="gdlr-core-text-box-item-content" style="font-size: 17px ;text-transform: none ;">
                                       <p>Formar profesionales de cuarto nivel, capaces de entender con profundidad los fundamentos de las
                                          instituciones procesales, su relevancia como mecanismo de resolución pacífica de controversias, y su rol
                                          como herramienta indispensable para garantizar los derechos de las partes y los procesados en el marco
                  ...
                  <div class="gdlr-core-pbf-wrapper-container clearfix gdlr-core-container">
                                       ...
                                       <ul>
                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                                                <span class="gdlr-core-icon-list-content" style="font-size: 16px;">Reflexionar crítica y propositivamente, sobre la aplicación del Derecho Procesal, sus principios e instituciones en cualquiera de las posiciones que desempeñe en la sociedad ya sea en el campo del libre ejercicio profesional o como servidor público, ya sea administrativo o integrante del sistema de administración de justicia.</span>
                                             </div>
                                          </li>
                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                                                <span class="gdlr-core-icon-list-content" style="font-size: 16px;">Manejo teórico-conceptual y fundamentalmente contextual o pragmático de la ciencia procesal, esto
                                                desde la óptica de la doctrina de las instituciones del derecho adjetivo que existen en el derecho
                                                ecuatoriano y su consecuente profundización, así como también del entendimiento en la praxis de
                                                casos reales.</span>
                                             </div>
                                          </li>
                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                                                <span class="gdlr-core-icon-list-content" style="font-size: 16px;">Resolver problemas jurídicos complejos a partir de la aplicación de los principios adecuados y de la hermenéutica adjetiva.</span>
                                             </div>
                                          </li>
                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                                                <span class="gdlr-core-icon-list-content" style="font-size: 16px;">Aportar a la construcción y elaboración de actos procesales de origen judicial adecuados para el cumplimiento de la garantía constitucional de motivación.</span>
                                             </div>
                                          </li>
                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                                                <span class="gdlr-core-icon-list-content" style="font-size: 16px;">Aplicar las garantías jurisdiccionales y los mecanismos de control constitucional como formas de tutelar los derechos constitucionales de las personas.</span>
                                             </div>
                                          </li>
                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                                                <span class="gdlr-core-icon-list-content" style="font-size: 16px;">Desarrollar destrezas para litigio internacional en materia de derechos humanos, ya sea en el Sistema interamericano de Derechos Humanos o en el Sistema Universal de Derechos Humanos.</span>
                                             </div>
                                          </li>
                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                                                <span class="gdlr-core-icon-list-content" style="font-size: 16px;">Implementar sus destrezas de litigación oral y estrategia procesal en casos de alta complejidad.</span>
                                             </div>
                                          </li>
                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                                                <span class="gdlr-core-icon-list-content" style="font-size: 16px;">Investigar sobre la problemática procesal actual en sede judicial y aplicar coherentemente las
                                                instituciones del derecho procesal contenidas, entre otros, en el Código Orgánico General de Procesos
                                                que regula la jurisdicción y actividad procesal en diversas materias, así como cumplir el mandato
                                                constitucional de respeto al derecho a la tutela judicial efectiva.</span>
                                             </div>
                                          </li>
                                       </ul>
                                    </div>
                     ...
                     <div class="gdlr-core-pbf-column gdlr-core-column-30" id="gdlr-core-column-36639">
                        <div class="gdlr-core-pbf-column-content-margin gdlr-core-js  gdlr-core-column-extend-right" data-sync-height="height-1" style="height: 653.976px;">
                           <div class="gdlr-core-pbf-background-wrap">
                              <div class="gdlr-core-pbf-background gdlr-core-parallax gdlr-core-js" style="background-image: url(../images/carreras/maestrias-derecho-06.jpg); background-size: cover; background-position: center center; height: 710.762px; transform: translate(0px, -35.625px);" data-parallax-speed="0.2"></div>
                           </div>
                           <div class="gdlr-core-pbf-column-content clearfix gdlr-core-js  gdlr-core-sync-height-content"></div>
                        </div>
                     </div>
                              ...
                              <div class="gdlr-core-pbf-element">
                                 <table>
                                    ...
                                    <tr style="background-color: #ffffff">
                                       <td>Derecho procesal orgánico y administración de justicia</td>
                                       <td>12</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                       <td>Procesos contenciosos generales y voluntarios</td>
                                       <td>12</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                       <td>Teoría General de la Prueba</td>
                                       <td>12</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                       <td>Procedimiento de mediación y arbitraje</td>
                                       <td>12</td>
                                    </tr>
                                    <tr>
                                       <td>Procedimiento en sede administrativa central y descentralizada</td>
                                       <td>12</td>
                                    </tr>
                                    <tr>
                                       <td>Procedimientos en sede de propiedad intelectual</td>
                                       <td>12</td>
                                    </tr>
                                    <tr>
                                       <td>Procedimientos internacionales en materia de derechos humanos</td>
                                       <td>12</td>
                                    </tr>
                                    <tr>
                                       <td>Procesos constitucionales en garantias jurisdiccionales</td>
                                       <td>12</td>
                                    </tr>
                                    <tr>
                                       <td>Proceso contenciosos administrativo y contencioso tributario</td>
                                       <td>18</td>
                                    </tr>
                                    <tr>
                                       <td>Titulación II</td>
