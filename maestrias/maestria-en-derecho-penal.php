   ...
   <div class="kingster-body-outer-wrapper ">
      <div class="kingster-body-wrapper clearfix  kingster-with-frame">
       <?php if ($utm_source != 'mailing' && $utm_source != 'landingpage'){include '../extended/top_bar.php'; include '../extended/menu_home.php';}?>
         <div class="kingster-page-title-wrap  kingster-style-custom kingster-left-align" style="background-image: url(../images/carreras/maestria-en-derecho-penal-top.jpg) ;">
            ...
            <div class="kingster-page-title-container kingster-container">
               <div class="kingster-page-title-content kingster-item-pdlr" style="padding-top: 200px ;padding-bottom: 80px ;">
                  ...
                  <h1 class="kingster-page-title" style="text-transform: none ;">Maestr&iacute;a en Derecho Penal</h1>
               </div>
            </div>
         </div>
                           ...
                           <div class="gdlr-core-pbf-element" style="background-color:#800f34;">
                              <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix  gdlr-core-center-align gdlr-core-title-item-caption-top gdlr-core-item-pdlr" style="padding-bottom: 15px; padding-top:15px;">
                                 <div class="gdlr-core-title-item-title-wrap clearfix">
                                    <h3 class="gdlr-core-title-item-title gdlr-core-skin-title " style="font-size: 26px ;font-weight: 600 ;letter-spacing: 0px ;text-transform: none ;color: #ffffff;margin-right: 30px;">Inauguración: <?php echo obtenerFechaInauguracion("Maestria en Derecho Penal OnLine");?></h3>
                                 </div>
                              </div>
                           </div>
                           ...
                           <div class="gdlr-core-pbf-element">
                              <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align">
                                 <div class="gdlr-core-text-box-item-content" style="font-size: 16px ;text-transform: none ;">
                                    <p>La Maestría en Derecho Penal 100% en línea está dirigida a profesionales del derecho con título de tercer
                                       nivel, debidamente inscrito en el SENESCYT.
                                    </p>
                                    <p><strong>Duraci&oacute;n De Programa:</strong> 12 Meses</p>
                                    <p><strong>Tutorías sincrónicas: </strong>Sábados de 08:00 – 14:00</p>
                                 </div>                                 
                              </div>
                           </div>
                                          ...
                                          <div class="gdlr-core-column-service-item gdlr-core-item-pdb  gdlr-core-left-align gdlr-core-column-service-icon-left gdlr-core-with-caption gdlr-core-item-pdlr" style="padding-bottom: 30px;">
                                             ...
                                             <div class="gdlr-core-column-service-content-wrapper">
                                                <div class="gdlr-core-column-service-title-wrap">
                                                   ...
                                                   <div class="gdlr-core-column-service-caption gdlr-core-info-font gdlr-core-skin-caption" style="font-size: 15px ;font-weight: 500 ;font-style: normal ;">Mag&iacute;ster en Derecho Penal</div>
                                                </div>
                                             </div>
                                          </div>
                                       </div>
                                          ...
                                          <div class="gdlr-core-column-service-item gdlr-core-item-pdb  gdlr-core-left-align gdlr-core-column-service-icon-left gdlr-core-with-caption gdlr-core-item-pdlr" style="padding-bottom: 30px;">
                                             ...
                                             <div class="gdlr-core-column-service-content-wrapper">
                                                <div class="gdlr-core-column-service-title-wrap">
                                                   ...
                                                   <div class="gdlr-core-column-service-caption gdlr-core-info-font gdlr-core-skin-caption" style="font-size: 15px ;font-weight: 500 ;font-style: normal ;">RPC-SO-10-No.191-2020</div>
                                                </div>
                                             </div>
                                          </div>
                                       </div>
                              ...
                              <div class="textwidget" style="box-shadow: 0 -6px 24px rgba(10, 10, 10,0.09); -moz-box-shadow: 0 -6px 24px rgba(10, 10, 10,0.09); -webkit-box-shadow: 0 -6px 24px rgba(10, 10, 10,0.09); background-color: #ffffff ;border-radius:  3px 3px ;-moz-border-radius:  3px 3px ;-webkit-border-radius:  3px 3px ;">
                                 <div class="gdlr-core-widget-box-shortcode " style="color: #821436 ;padding: 25px 5px;background-color: #ffffff ;">
                                    <div class="gdlr-core-widget-box-shortcode-content">
                                       ...
                                       <div class="gdlr-core-pbf-element">
                                          <div id="form-73721"></div>
                                          <script src="https://webservices.uees.edu.ec/formularios/v2/form-embed.js" data-programa-id="737" data-nivel-id="2" data-modalidad-id="1" data-height="900" data-container="form-73721" defer></script>
                                       </div>
                                    </div>
                                 </div>
                              </div>
                     ...
                     <div class="gdlr-core-pbf-column gdlr-core-column-30 gdlr-core-column-first" id="gdlr-core-column-8638">
                        <div class="gdlr-core-pbf-column-content-margin gdlr-core-js  gdlr-core-column-extend-left" data-sync-height="height-2" style="height: 860.461px;">
                           <div class="gdlr-core-pbf-background-wrap">
                              <div class="gdlr-core-pbf-background gdlr-core-parallax gdlr-core-js" style="background-image: url(../images/carreras/maestrias-derecho-03.jpg); background-size: cover; background-position: center center; height: 875.969px; transform: translate(0px, -43.5328px);" data-parallax-speed="0.2"></div>
                           </div>
                              ...
                              <div class="gdlr-core-pbf-element">
                                 <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align">
                                    <div class="gdlr-core-text-box-item-content" style="font-size: 17px ;text-transform: none ;">
                                       <p>Consolidar la formación en el campo de las ciencias penales, para alcanzar un adecuado desarrollo del
                                          sistema penal y una visión integral sobre la capacidad litigiosa y resolutiva de los maestrantes, en base a
                                          la estructura, su influencia y funciones del Derecho Penal en el ordenamiento jurídico del País.
                                       </p>
                                    </div>
                                 </div>
                              </div>
                  ...
                  <div class="gdlr-core-pbf-wrapper-container clearfix gdlr-core-container">
                                       ...
                                       <ul>
                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                                                <span class="gdlr-core-icon-list-content" style="font-size: 16px;">Desenvolverse eficientemente en el ámbito del derecho penal sustantivo y adjetivo.</span>
                                             </div>
                                          </li>
                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                                                <span class="gdlr-core-icon-list-content" style="font-size: 16px;">Dominar los conceptos fundamentales de la criminología y sus ciencias afines que permitan una actuación adecuada en el proceso penal.</span>
                                             </div>
                                          </li>
                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                                                <span class="gdlr-core-icon-list-content" style="font-size: 16px;">Desarrollar destrezas en técnicas de litigación oral.</span>
                                             </div>
                                          </li>
                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                                                <span class="gdlr-core-icon-list-content" style="font-size: 16px;">Elaborar propuestas destinadas a propiciar cambios proactivos en la aplicación del derecho penal.</span>
                                             </div>
                                          </li>
                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                                                <span class="gdlr-core-icon-list-content" style="font-size: 16px;">Formular una visión holística de las ciencias auxiliares del derecho penal, su aplicación y efectos en la sociedad ecuatoriana.</span>
                                             </div>
                                          </li>
                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                                                <span class="gdlr-core-icon-list-content" style="font-size: 16px;">Formular propuestas de políticas públicas que permitan alcanzar los mínimos necesarios para un goce efectivo de los derechos.</span>
                                             </div>
                                          </li>
                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                                                <span class="gdlr-core-icon-list-content" style="font-size: 16px;">Tener una visión de las instituciones del proceso penal en el estudio comparado de la legislación interna ecuatoriana e internacional.</span>
                                             </div>
                                          </li>
                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                                                <span class="gdlr-core-icon-list-content" style="font-size: 16px;">Comprender las diversas escuelas teórico-dogmáticas del Derecho Penal y sus implicaciones prácticas.</span>
                                             </div>
                                          </li>
                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                                                <span class="gdlr-core-icon-list-content" style="font-size: 16px;">Efectuar un eficaz análisis interdisciplinario del conflicto social y de las soluciones que proporciona el derecho penal.</span>
                                             </div>
                                          </li>
                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                                                <span class="gdlr-core-icon-list-content" style="font-size: 16px;">Comprender los factores sociales e individuales que determinan las conductas delictivas del sujeto.</span>
                                             </div>
                                          </li>
                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                                                <span class="gdlr-core-icon-list-content" style="font-size: 16px;">Entender el sistema jurídico con una visión intercultural e incluyente de grupos de atención prioritaria, así como con perspectiva de protección de los derechos de la mujer y miembros del núcleo familiar.</span>
                                             </div>
                                          </li>
                                       </ul>
                                    </div>
                     ...
                     <div class="gdlr-core-pbf-column gdlr-core-column-30" id="gdlr-core-column-36639">
                        <div class="gdlr-core-pbf-column-content-margin gdlr-core-js  gdlr-core-column-extend-right" data-sync-height="height-1" style="height: 653.976px;">
                           <div class="gdlr-core-pbf-background-wrap">
                              <div class="gdlr-core-pbf-background gdlr-core-parallax gdlr-core-js" style="background-image: url(../images/carreras/maestrias-derecho-04.jpg); background-size: cover; background-position: center center; height: 710.762px; transform: translate(0px, -35.625px);" data-parallax-speed="0.2"></div>
                           </div>
                           <div class="gdlr-core-pbf-column-content clearfix gdlr-core-js  gdlr-core-sync-height-content"></div>
                        </div>
                     </div>
                              ...
                              <div class="gdlr-core-pbf-element">
                                 <table>
                                    ...
                                    <tr style="background-color: #ffffff">
                                       <td>Criminalística y técnicas de investigación</td>
                                       <td>12</td>
                                    </tr>
                                    <tr>
                                       <td>Criminología y política criminal</td>
                                       <td>12</td>
                                    </tr>
                                    <tr>
                                       <td>Cuestiones actuales de derecho penal</td>
                                       <td>12</td>
                                    </tr>
                                    <tr>
                                       <td>Dogmática penal</td>
                                       <td>24</td>
                                    </tr>
                                    <tr>
                                       <td>Estrategias de litigación penal</td>
                                       <td>12</td>
                                    </tr>
                                    <tr>
                                       <td>Principios constitucionales del derecho penal</td>
                                       <td>6</td>
                                    </tr>
                                    <tr>
                                       <td>Procedimiento penal y ejecución penitenciaria</td>
                                       <td>12</td>
                                    </tr>
                                    <tr>
                                       <td>Titulación I: Metodología de investigación</td>
                                       <td>6</td>
                                    </tr>
                                    <tr>
                                       <td>Crimen organizado y seguridadad del estado</td>
                                       <td>18</td>
                                    </tr>
                                    <tr>
                                       <td>Delitos aduaneros y tributarios</td>
                                       <td>12</td>
                                    </tr>
                                    <tr>
                                       <td>Delitos contra la administración pública y de justicia</td>
                                       <td>12</td>
                                    </tr>
                                    <tr>
                                       <td>Delitos contra la mujer y el nucleo familiar</td>
                                       <td>6</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                       <td>Delitos de lavados de activos</td>
                                       <td>12</td>
                                    </tr>
                                    <tr>
                                       <td>Delitos económicos y patrimoniales</td>
                                       <td>12</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                       <td>Responsabilidad penal de las personas jurídicas</td>
                                       <td>6</td>
                                    </tr>
                                    <tr>
                                       <td>Titulaci&oacute;n II</td>
                                       <td>24</td>
                                    </tr>
                                 </table>
                              </div>
