...
<body class="home page-template-default page page-id-2039 gdlr-core-body woocommerce-no-js tribe-no-js kingster-body kingster-body-front kingster-full  kingster-with-sticky-navigation  kingster-blockquote-style-1 gdlr-core-link-to-lightbox">
   ...
   <div class="kingster-body-outer-wrapper ">
      <div class="kingster-body-wrapper clearfix  kingster-with-frame">
         ...
         <div class="kingster-page-title-wrap  kingster-style-custom kingster-left-align" style="background-image: url(../images/carreras/maestria-en-negociacion-mediacion-arbitraje-top.jpg) ;">
            ...
            <div class="kingster-page-title-container kingster-container">
               <div class="kingster-page-title-content kingster-item-pdlr" style="padding-top: 200px ;padding-bottom: 80px ;">
                  ...
                  <h1 class="kingster-page-title" style="text-transform: none ;">Maestr&iacute;a en Negociación, Mediación y Arbitraje</h1>
               </div>
            </div>
         </div>
                           ...
                           <div class="gdlr-core-pbf-element" style="background-color:#800f34;">
                              <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix  gdlr-core-center-align gdlr-core-title-item-caption-top gdlr-core-item-pdlr" style="padding-bottom: 15px; padding-top:15px;">
                                 <div class="gdlr-core-title-item-title-wrap clearfix">
                                    <h3 class="gdlr-core-title-item-title gdlr-core-skin-title " style="font-size: 26px ;font-weight: 600 ;letter-spacing: 0px ;text-transform: none ;color: #ffffff;margin-right: 30px;">Inauguración: <?php echo obtenerFechaInauguracion("Maestria en Negociacion, Mediacion y Arbitraje");?></h3>                                    
                                 </div>
                              </div>
                           </div>
                           ...
                           <div class="gdlr-core-pbf-element">
                              <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align">
                                 <div class="gdlr-core-text-box-item-content" style="font-size: 16px ;text-transform: none ;">
                                    <p>El programa de Maestría en Negociación, Mediación y Arbitraje, está dirigido a profesionales de tercer nivel
                                        de grado preferentemente en el campo específico del Derecho; otros campos de formación deben acreditar
                                        2 años de experiencia en áreas a fines, que estén interesados en profundizar en su formación de resolución
                                        alternativa de conflictos y obtener formación especializada frente a los nuevos retos profesionales dentro
                                        del mundo jurídico y la justicia alternativa.
                                    </p>
                                    <p><strong>Duraci&oacute;n De Programa:</strong> 12 Meses</p>
                                    <p><strong>Tutorías sincrónicas: </strong> sábados de 08:00 a 13:00</p>
                                 </div>                                 
                              </div>
                           </div>
                                          ...
                                          <div class="gdlr-core-column-service-item gdlr-core-item-pdb  gdlr-core-left-align gdlr-core-column-service-icon-left gdlr-core-with-caption gdlr-core-item-pdlr" style="padding-bottom: 30px;">
                                             ...
                                             <div class="gdlr-core-column-service-content-wrapper">
                                                <div class="gdlr-core-column-service-title-wrap">
                                                   ...
                                                   <div class="gdlr-core-column-service-caption gdlr-core-info-font gdlr-core-skin-caption" style="font-size: 15px ;font-weight: 500 ;font-style: normal ;">Mag&iacute;ster en Negociación, Mediación y Arbitraje</div>
                                                </div>
                                             </div>
                                          </div>
                                       </div>
                                          ...
                                          <div class="gdlr-core-column-service-item gdlr-core-item-pdb  gdlr-core-left-align gdlr-core-column-service-icon-left gdlr-core-with-caption gdlr-core-item-pdlr" style="padding-bottom: 30px;">
                                             ...
                                             <div class="gdlr-core-column-service-content-wrapper">
                                                <div class="gdlr-core-column-service-title-wrap">
                                                   ...
                                                   <div class="gdlr-core-column-service-caption gdlr-core-info-font gdlr-core-skin-caption" style="font-size: 15px ;font-weight: 500 ;font-style: normal ;">RPC-SO-13-No.235-2024</div>
                                                </div>
                                             </div>
                                          </div>
                                       </div>
                              ...
                              <div class="textwidget" style="box-shadow: 0 -6px 24px rgba(10, 10, 10,0.09); -moz-box-shadow: 0 -6px 24px rgba(10, 10, 10,0.09); -webkit-box-shadow: 0 -6px 24px rgba(10, 10, 10,0.09); background-color: #ffffff ;border-radius:  3px 3px ;-moz-border-radius:  3px 3px ;-webkit-border-radius:  3px 3px ;">
                                 <div class="gdlr-core-widget-box-shortcode " style="color: #821436 ;padding: 25px 5px;background-color: #ffffff ;">
                                    <div class="gdlr-core-widget-box-shortcode-content">
                                       ...
                                       <div class="gdlr-core-pbf-element">
                                          <div id="form-77521"></div>
                                          <script src="https://webservices.uees.edu.ec/formularios/v2/form-embed.js" data-programa-id="775" data-nivel-id="2" data-modalidad-id="1" data-height="900" data-container="form-77521" defer></script>
                                       </div>
                                    </div>
                                 </div>
                              </div>
                     ...
                     <div class="gdlr-core-pbf-column gdlr-core-column-30 gdlr-core-column-first" id="gdlr-core-column-8638">
                        <div class="gdlr-core-pbf-column-content-margin gdlr-core-js  gdlr-core-column-extend-left" data-sync-height="height-2" style="height: 860.461px;">
                           <div class="gdlr-core-pbf-background-wrap">
                              <div class="gdlr-core-pbf-background gdlr-core-parallax gdlr-core-js" style="background-image: url(../images/carreras/maestria-en-negociacion-mediacion-arbitraje-02.jpg); background-size: cover; background-position: center center; height: 875.969px; transform: translate(0px, -43.5328px);" data-parallax-speed="0.2"></div>
                           </div>
                              ...
                              <div class="gdlr-core-pbf-element">
                                 <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align">
                                    <div class="gdlr-core-text-box-item-content" style="font-size: 17px ;text-transform: none ;">
                                       <p>Formar profesionales altamente especializados en la resolución de conflictos de manera pacífica y efectiva,
                                            frente a los nuevos retos profesionales dentro del mundo jurídico y la justicia alternativa y desarrollar
                                            habilidades de comunicación mediante las cuales podrá implementar procesos de negociación
                                            colaborativa en la construcción de acuerdos de mutuo beneficio como la posibilidad de aplicar métodos
                                            autocompositivos de resolución de conflictos.
                                       </p>
                                    </div>
                                 </div>
                              </div>
                                       ...
                                       <ul>
                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                                                <span class="gdlr-core-icon-list-content" style="font-size: 16px;text-align: justify;">Desarrollar habilidades de comunicación mediante las cuales podrá implementar procesos de
                                                    negociación colaborativa en la construcción de acuerdos de mutuo beneficio como la posibilidad de
                                                    aplicar métodos autocompositivos de resolución de conflictos.</span>
                                             </div>
                                          </li>
                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                                                <span class="gdlr-core-icon-list-content" style="font-size: 16px;text-align: justify;">Dominar el proceso comunicacional partiendo de la escucha activa hasta el perfeccionamiento del
cambio de ideas del emisor y el receptor y, en general, los procesos de transferencia de información.</span>
                                             </div>
                                          </li>
                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                                                <span class="gdlr-core-icon-list-content" style="font-size: 16px;text-align: justify;">Contribuir a la sociedad en la gestión de los conflictos, la desescalada y la resolución de los mismos,
generando así la disminución de los niveles de conflictividad social, produciendo dinámicas positivas de
las relaciones de las personas en los diferentes ámbitos.</span>
                                             </div>
                                          </li>
                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                                                <span class="gdlr-core-icon-list-content" style="font-size: 16px;text-align: justify;">Comprender científica y metodológicamente a través de la investigación los objetos propios de la
negociación, la mediación y el arbitraje, en perspectiva teórica o aplicada para comprender la
problemática reflejada en el quehacer de las instituciones de la negociación, mediación y arbitraje tales
como: la aplicación de métodos autocompositivos de resolución de conflictos, la interpretación y
aplicación de la ley de mediación y arbitraje, administración de recursos y personal.</span>
                                             </div>
                                          </li>
                     ...
                     <div class="gdlr-core-pbf-column gdlr-core-column-30" id="gdlr-core-column-36639">
                        <div class="gdlr-core-pbf-column-content-margin gdlr-core-js  gdlr-core-column-extend-right" data-sync-height="height-1" style="height: 653.976px;">
                           <div class="gdlr-core-pbf-background-wrap">
                              <div class="gdlr-core-pbf-background gdlr-core-parallax gdlr-core-js" style="background-image: url(../images/carreras/maestria-en-negociacion-mediacion-arbitraje-01.jpg); background-size: cover; background-position: center center; height: 710.762px; transform: translate(0px, -35.625px);" data-parallax-speed="0.2"></div>
                           </div>
                           <div class="gdlr-core-pbf-column-content clearfix gdlr-core-js  gdlr-core-sync-height-content"></div>
                        </div>
                     </div>
                              ...
                              <div class="gdlr-core-pbf-element">
                                 <table>
                                    ...
                                    <tr style="background-color: #ffffff">
                                       <td>Fundamentos del a Mediación, Arbitraje y Negociación, Modelo Harvard</td>
                                       <td>18</td>
                                    </tr>
                                    <tr>
                                       <td>Conflictología</td>
                                       <td>18</td>
                                    </tr>
                                    <tr>
                                       <td>Cultura de la Legalidad y Liderazgo Ético</td>
                                       <td>12</td>
                                    </tr>                                    
                                    <tr>
                                       <td>Comunicación Argumentativa - Colaborativa</td>
                                       <td>12</td>
                                    </tr>
                                    <tr>
                                       <td>Arbitraje Doméstico</td>
                                       <td>24</td>
                                    </tr>
                                    <tr>
                                       <td>Arbitraje Internacional</td>
                                       <td>24</td>
                                    </tr>
                                    <tr>
                                       <td>Arbitraje de Inversiones</td>
                                       <td>24</td>
                                    </tr>
                                    <tr>
                                       <td>Prácticas de Negociación y Mediación</td>
                                       <td>24</td>
                                    </tr>
                                    <tr>
