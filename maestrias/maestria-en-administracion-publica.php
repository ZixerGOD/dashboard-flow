...
<body class="home page-template-default page page-id-2039 gdlr-core-body woocommerce-no-js tribe-no-js kingster-body kingster-body-front kingster-full  kingster-with-sticky-navigation  kingster-blockquote-style-1 gdlr-core-link-to-lightbox">
   ...
   <div class="kingster-body-outer-wrapper ">
      <div class="kingster-body-wrapper clearfix  kingster-with-frame">
         ...
         <div class="kingster-page-title-wrap  kingster-style-custom kingster-left-align" style="background-image: url(../images/carreras/maestria-en-administracion-publica-top.jpg) ;">
            ...
            <div class="kingster-page-title-container kingster-container">
               <div class="kingster-page-title-content kingster-item-pdlr" style="padding-top: 200px ;padding-bottom: 80px ;">
                  ...
                  <h1 class="kingster-page-title" style="text-transform: none ;">Maestr&iacute;a en Administraci&oacute;n P&uacute;blica</h1>
               </div>
            </div>
         </div>
                           ...
                           <div class="gdlr-core-pbf-element" style="background-color:#800f34;">
                              <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix  gdlr-core-center-align gdlr-core-title-item-caption-top gdlr-core-item-pdlr" style="padding-bottom: 15px; padding-top:15px;">
                                 <div class="gdlr-core-title-item-title-wrap clearfix">
                                    <h3 class="gdlr-core-title-item-title gdlr-core-skin-title " style="font-size: 26px ;font-weight: 600 ;letter-spacing: 0px ;text-transform: none ;color: #ffffff;margin-right: 30px;">Inauguración: <?php echo obtenerFechaInauguracion("ESAI Maestria en Administracion Publica OnLine");?></h3>                                    
                                 </div>
                              </div>
                           </div>
                           ...
                           <div class="gdlr-core-pbf-element">
                              <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align">
                                 <div class="gdlr-core-text-box-item-content" style="font-size: 16px ;text-transform: none ;">
                                    <p>La Maestría en Administración Pública 100% en línea está dirigida a profesionales con títulos de tercer nivel
                                       preferentemente ingenieros o licenciados en administración, (ingenieros o licenciados en gestión financiera,
                                       ingenieros o licenciados en contabilidad y auditoría, licenciados o ingenieros en administración, licenciados
                                       o ingenieros en mercadotecnia y publicidad, licenciados o ingenieros en comercio) para las otras áreas de
                                       conocimiento: licenciados en educación, ciencias sociales y del comportamiento (economista, licenciados
                                       en ciencias políticas y psicólogos), licenciados en derecho, ingenieros en tecnologías de la información y
                                       comunicación (TIC), ingenieros industriales, médicos, ingenieros civiles, arquitectos, se solicita 1 año de
                                          ...
                                          <div class="gdlr-core-column-service-item gdlr-core-item-pdb  gdlr-core-left-align gdlr-core-column-service-icon-left gdlr-core-with-caption gdlr-core-item-pdlr" style="padding-bottom: 30px;">
                                             ...
                                             <div class="gdlr-core-column-service-content-wrapper">
                                                <div class="gdlr-core-column-service-title-wrap">
                                                   ...
                                                   <div class="gdlr-core-column-service-caption gdlr-core-info-font gdlr-core-skin-caption" style="font-size: 15px ;font-weight: 500 ;font-style: normal ;">Mag&iacute;ster en Administraci&oacute;n P&uacute;blica</div>
                                                </div>
                                             </div>
                                          </div>
                                       </div>
                              ...
                              <div class="textwidget" style="box-shadow: 0 -6px 24px rgba(10, 10, 10,0.09); -moz-box-shadow: 0 -6px 24px rgba(10, 10, 10,0.09); -webkit-box-shadow: 0 -6px 24px rgba(10, 10, 10,0.09); background-color: #ffffff ;border-radius:  3px 3px ;-moz-border-radius:  3px 3px ;-webkit-border-radius:  3px 3px ;">
                                 <div class="gdlr-core-widget-box-shortcode " style="color: #821436 ;padding: 25px 5px;background-color: #ffffff ;">
                                    <div class="gdlr-core-widget-box-shortcode-content">
                                       ...
                                       <div class="gdlr-core-pbf-element">
                                          <div id="form-73321"></div>
                                          <script src="https://webservices.uees.edu.ec/formularios/v2/form-embed.js" data-programa-id="733" data-nivel-id="2" data-modalidad-id="1" data-height="900" data-container="form-73321" defer></script>
                                       </div>
                                    </div>
                                 </div>
                              </div>
                     ...
                     <div class="gdlr-core-pbf-column gdlr-core-column-30 gdlr-core-column-first" id="gdlr-core-column-8638">
                        <div class="gdlr-core-pbf-column-content-margin gdlr-core-js  gdlr-core-column-extend-left" data-sync-height="height-2" style="height: 860.461px;">
                           <div class="gdlr-core-pbf-background-wrap">
                              <div class="gdlr-core-pbf-background gdlr-core-parallax gdlr-core-js" style="background-image: url(../images/carreras/maestria-en-administracion-publica-01.jpg); background-size: cover; background-position: center center; height: 875.969px; transform: translate(0px, -43.5328px);" data-parallax-speed="0.2"></div>
                           </div>
                              ...
                              <div class="gdlr-core-pbf-element">
                                 <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align">
                                    <div class="gdlr-core-text-box-item-content" style="font-size: 17px ;text-transform: none ;">
                                       <p>Formar profesionales calificados en la gestión y liderazgo de organismos gubernamentales regionales y
                                       locales, capaces de formular e implementar políticas y estrategias que contribuyan a mejorar el
                                       desempeño de sus instituciones.</p>
                                    </div>
                                 </div>
                              </div>
                           </div>
                  ...
                  <div class="gdlr-core-pbf-wrapper-container clearfix gdlr-core-container">
                                       ...
                                       <ul>
                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                                                <span class="gdlr-core-icon-list-content" style="font-size: 16px;">Diseñar, implementar y evaluar políticas públicas a partir del análisis y crítica de los aspectos políticos,
                                                económicos, financieros, sociales, legales y administrativos, involucrados en la gestión pública.</span>
                                             </div>
                                          </li>
                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                                                <span class="gdlr-core-icon-list-content" style="font-size: 16px;">Liderar y gestionar organismos gubernamentales tomando en cuenta la interculturalidad, los saberes, el
                                                género y el respeto a los derechos del buen vivir de los usuarios de los organismos públicos.</span>
                                             </div>
                                          </li>
                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                                                <span class="gdlr-core-icon-list-content" style="font-size: 16px;">Consolidar equipos de colaboradores que sean multidisciplinarios, interdisciplinarios, cohesionados,
                                                con valores y principios, respetuosos de la interculturalidad, los derechos del buen vivir y crítico de sus
                                                acciones, mediante la aplicación del Liderazgo y Negociación, los valores y la ética profesional.</span>
                                             </div>
                                          </li>                                          
                                       </ul>
                                    </div>
                     ...
                     <div class="gdlr-core-pbf-column gdlr-core-column-30" id="gdlr-core-column-36639">
                        <div class="gdlr-core-pbf-column-content-margin gdlr-core-js  gdlr-core-column-extend-right" data-sync-height="height-1" style="height: 653.976px;">
                           <div class="gdlr-core-pbf-background-wrap">
                              <div class="gdlr-core-pbf-background gdlr-core-parallax gdlr-core-js" style="background-image: url(../images/carreras/maestria-en-administracion-publica-02.jpg); background-size: cover; background-position: center center; height: 710.762px; transform: translate(0px, -35.625px);" data-parallax-speed="0.2"></div>
                           </div>
                           <div class="gdlr-core-pbf-column-content clearfix gdlr-core-js  gdlr-core-sync-height-content"></div>
                        </div>
                     </div>
                              ...
                              <div class="gdlr-core-pbf-element">
                                 <table style="width: 100%">
                                    ...
                                    <tr style="background-color: #ffffff">
                                       <td >Control interno y externo de auditoria</td>
                                       <td>12</td>
                                    </tr>
                                    <tr>
                                       <td>Economía del sector público</td>
                                       <td>12</td>
                                    </tr>
                                    <tr>
                                       <td>Estadística</td>
                                    ...
                                    <tr>
                                       <td>Etica y administración estratégica del talento humano</td>
                                       <td>12</td>
                                    </tr>
                                    <tr>
                                       <td>Liderazgo</td>
                                    ...
                                    <tr>
                                       <td>Métodos de solución de conflictos</td>
                                       <td>12</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                       <td>Administración financiera del sector público</td>
                                       <td>12</td>
                                    </tr>                                    
                                    <tr>
                                       <td>Comportamiento y comunicación</td>
                                       <td>12</td>
                                    </tr>
                                    <tr>
                                       <td>Derecho administrativo y contratación pública</td>
                                       <td>18</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                       <td>Gestión de proceso y sostenibilidad</td>
                                       <td>12</td>
                                    </tr>
                                    <tr>
