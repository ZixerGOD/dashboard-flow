...
<body class="home page-template-default page page-id-2039 gdlr-core-body woocommerce-no-js tribe-no-js kingster-body kingster-body-front kingster-full  kingster-with-sticky-navigation  kingster-blockquote-style-1 gdlr-core-link-to-lightbox">
   ...
   <div class="kingster-body-outer-wrapper ">
      <div class="kingster-body-wrapper clearfix  kingster-with-frame">
         ...
         <div class="kingster-page-title-wrap  kingster-style-custom kingster-left-align" style="background-image: url(../images/carreras/Maestria-en-direccion-de-empresas-con-mencion-en-gestion-de-empresas-de-servicios-top.jpg) ;">
            ...
            <div class="kingster-page-title-container kingster-container">
               <div class="kingster-page-title-content kingster-item-pdlr" style="padding-top: 200px ;padding-bottom: 80px ;">
                  ...
                  <h1 class="kingster-page-title" style="text-transform: none ;">Maestr&iacute;a en Direcci&oacute;n de Empresas con Menci&oacute;n en Gesti&oacute;n de Empresas de Servicios</h1>
               </div>
            </div>
         </div>
                           ...
                           <div class="gdlr-core-pbf-element" style="background-color:#800f34;">
                              <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix  gdlr-core-center-align gdlr-core-title-item-caption-top gdlr-core-item-pdlr" style="padding-bottom: 15px; padding-top:15px;">
                                 <div class="gdlr-core-title-item-title-wrap clearfix">
                                    <h3 class="gdlr-core-title-item-title gdlr-core-skin-title " style="font-size: 26px ;font-weight: 600 ;letter-spacing: 0px ;text-transform: none ;color: #ffffff;margin-right: 30px;">Próximo Inicio 27 de Octubre del 2023</h3>                                    
                                 </div>
                              </div>
                           </div>
                           ...
                           <div class="gdlr-core-pbf-element">
                              <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align">
                                 <div class="gdlr-core-text-box-item-content" style="font-size: 16px ;text-transform: none ;">
                                    <p>La Maestría en Dirección de Empresas con Mención en Gestión de Empresas de Servicios 100% en línea está 
                                       dirigida a profesionales de tercer nivel de grado con títulos de ingenieros y licenciados, preferentemente 
                                       afines al campo de administración. Para los campos de educación, tecnologías de la información y 
                                       comunicación, ciencias sociales, periodismo, información y derecho o ingeniería (industria y construcción), 
                                       salud y bienestar (medicina) se solicita 1 año de experiencia profesional en el área de planeación estratégica, 
                                       operaciones, marketing, comercial, finanzas o administración.
                                    </p>
                                    <p><strong>Duraci&oacute;n De Programa:</strong> 12 Meses</p>
                                    <p><strong>Horario Sincr&oacute;nico: </strong> sábados de 08:00 – 13:00</p>
                                 </div>                                 
                              </div>
                           </div>
                                          ...
                                          <div class="gdlr-core-column-service-item gdlr-core-item-pdb  gdlr-core-left-align gdlr-core-column-service-icon-left gdlr-core-with-caption gdlr-core-item-pdlr" style="padding-bottom: 30px;">
                                             ...
                                             <div class="gdlr-core-column-service-content-wrapper">
                                                <div class="gdlr-core-column-service-title-wrap">
                                                   ...
                                                   <div class="gdlr-core-column-service-caption gdlr-core-info-font gdlr-core-skin-caption" style="font-size: 15px ;font-weight: 500 ;font-style: normal ;">Mag&iacute;ster en Direcci&oacute;n de Empresas con Menci&oacute;n Gesti&oacute;n de Empresas de Servicios.</div>
                                                </div>
                                             </div>
                                          </div>
                                       </div>
                                          ...
                                          <div class="gdlr-core-column-service-item gdlr-core-item-pdb  gdlr-core-left-align gdlr-core-column-service-icon-left gdlr-core-with-caption gdlr-core-item-pdlr" style="padding-bottom: 30px;">
                                             ...
                                             <div class="gdlr-core-column-service-content-wrapper">
                                                <div class="gdlr-core-column-service-title-wrap">
                                                   ...
                                                   <div class="gdlr-core-column-service-caption gdlr-core-info-font gdlr-core-skin-caption" style="font-size: 15px ;font-weight: 500 ;font-style: normal ;">RPC-SO-19-No.278-2018 <br> RPC-SO-17-No.278-2022</div>
                                                </div>
                                             </div>
                                          </div>
                                       </div>
                              ...
                              <div class="textwidget" style="box-shadow: 0 -6px 24px rgba(10, 10, 10,0.09); -moz-box-shadow: 0 -6px 24px rgba(10, 10, 10,0.09); -webkit-box-shadow: 0 -6px 24px rgba(10, 10, 10,0.09); background-color: #ffffff ;border-radius:  3px 3px ;-moz-border-radius:  3px 3px ;-webkit-border-radius:  3px 3px ;">
                                 <div class="gdlr-core-widget-box-shortcode " style="color: #821436 ;padding: 25px 5px;background-color: #ffffff ;">
                                    <div class="gdlr-core-widget-box-shortcode-content">
                                       ...
                                       <div class="gdlr-core-pbf-element">
                                          <iframe src="https://webservices.uees.edu.ec/formularios/formulario-web-postgrado.php?c=Maestria en Direccion de Empresas con Mencion en Gestion de Empresas de Servicios Online&m=Online&n=Postgrado" style="height:500px;width:100%;border:none;" title="Formulario Web"></iframe>
                                       </div>
                                    </div>
                                 </div>
                              </div>
                                       ...
                                       <ul>
                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                                                <span class="gdlr-core-icon-list-content" style="font-size: 16px;">Desarrollar competencias que permitan la toma de decisiones en las áreas de administración a través del 
                                                manejo de las herramientas que juegan un papel protagónico en la gestión y dirección de las 
                                                organizaciones de servicios, aplicando los fundamentos cognitivos y de investigación, que le permitan 
                                                contribuir a la creación y fortalecimiento de las empresas a nivel local, regional y nacional; con 
                                                responsabilidad social y enfoque económico, cultural y ambiental que generen alternativas de desarrollo 
                                                sostenible.</span>
                                             </div>
                                          </li>                                          
                                       </ul>
                  ...
                  <div class="gdlr-core-pbf-wrapper-container clearfix gdlr-core-container">
                                 ...
                                 <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align">
                                    <div class="gdlr-core-text-box-item-content" style="font-size: 17px ;text-transform: none ;">
                                       <ul>
                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                                                <span class="gdlr-core-icon-list-content" style="font-size: 16px;">Una visión estratégica e internacional de los negocios, capaz de asumir los retos de la globalización y evolución tecnológica del siglo XXI.</span>
                                             </div>
                                          </li>
                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                                                <span class="gdlr-core-icon-list-content" style="font-size: 16px;"> Conocimientos para desarrollar e implementar estrategias enfocadas en empresas de servicios, que respondan a las necesidades del mercado, con criterio innovador y participativo</span>
                                             </div>
                                          </li>
                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                                                <span class="gdlr-core-icon-list-content" style="font-size: 16px;">Habilidades para dirigir, liderar, motivar y gestionar equipos de trabajo.</span>
                                             </div>
                                          </li>
                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                                                <span class="gdlr-core-icon-list-content" style="font-size: 16px;">Capacidad para tomar decisiones a través del desarrollo de estrategias, el análisis crítico y la reflexionar sobre los desafíos del entorno. </span>
                                             </div>
                                          </li>
                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                                                <span class="gdlr-core-icon-list-content" style="font-size: 16px;">Conocimientos cuantitativos, cualitativos y técnicos necesarios para dirigir una empresa de servicios en todas sus áreas de negocio.</span>
                                             </div>
                                          </li>
                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                                                <span class="gdlr-core-icon-list-content" style="font-size: 16px;">Habilidades de comunicación, y negociación, que permitan solucionar conflictos y alcanzar los objetivos propuestos por una organización que oferta servicio</span>
                                             </div>
                                          </li>
                                       </ul>
                                    </div>
                     ...
                     <div class="gdlr-core-pbf-column gdlr-core-column-30" id="gdlr-core-column-36639">
                        <div class="gdlr-core-pbf-column-content-margin gdlr-core-js  gdlr-core-column-extend-right" data-sync-height="height-1" style="height: 653.976px;">
                           <div class="gdlr-core-pbf-background-wrap">
                              <div class="gdlr-core-pbf-background gdlr-core-parallax gdlr-core-js" style="background-image: url(../images/carreras/Maestria-en-direccion-de-empresas-con-mencion-en-gestion-de-empresas-de-servicios-02.jpg); background-size: cover; background-position: center center; height: 710.762px; transform: translate(0px, -35.625px);" data-parallax-speed="0.2"></div>
                           </div>
                           <div class="gdlr-core-pbf-column-content clearfix gdlr-core-js  gdlr-core-sync-height-content"></div>
                        </div>
                     </div>
                              ...
                              <div class="gdlr-core-pbf-element">
                                 <table>
                                    ...
                                    <tr style="background-color: #ffffff">
                                       <td>Liderazgo, Negociación y Creatividad </td>
                                       <td>12</td>
                                    </tr>
                                    <tr>
                                       <td>Geopolítica, Ética y Sostenibilidad de las Organizaciones</td>
                                       <td>18</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                       <td>Inteligencia de Negocios y Ciencia de Datos </td>
                                       <td>18</td>
                                    </tr>
                                    <tr>
                                       <td>Cadena de Valor, Gestión de Operaciones y Servicio al Cliente</td>
                                       <td>18</td>
                                    </tr>
                                    <tr>
                                       <td>Titulación I: Metodología de la investigacíon</td>
                                       <td>12</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                       <td>Dirección Comercial y Gestión de Ventas</td>
                                       <td>12</td>
                                    </tr>
                                    <tr>
                                       <td>Dirección y Planeación Estratégica del Marketing</td>
                                       <td>12</td>
                                    </tr>
                                    <tr>
                                       <td>Brand Management and Communication</td>
                                       <td>12</td>
                                    </tr>
                                    <tr>
                                       <td>Gestión de la Innovación y Desarrollo del Servicio</td>
                                       <td>18</td>
                                    </tr>
                                    <tr>
