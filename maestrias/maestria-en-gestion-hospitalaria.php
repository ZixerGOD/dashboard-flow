...
<body class="home page-template-default page page-id-2039 gdlr-core-body woocommerce-no-js tribe-no-js kingster-body kingster-body-front kingster-full  kingster-with-sticky-navigation  kingster-blockquote-style-1 gdlr-core-link-to-lightbox">
   ...
   <div class="kingster-body-outer-wrapper ">
      <div class="kingster-body-wrapper clearfix  kingster-with-frame">
         ...
         <div class="kingster-page-title-wrap  kingster-style-custom kingster-left-align" style="background-image: url(../images/carreras/maestria-en-gestion-hospitalaria-top.png) ;">
            ...
            <div class="kingster-page-title-container kingster-container">
               <div class="kingster-page-title-content kingster-item-pdlr" style="padding-top: 200px ;padding-bottom: 80px ;">
                  ...
                  <h1 class="kingster-page-title" style="text-transform: none ;">Maestr&iacute;a en Gestión Hospitalaria</h1>
               </div>
            </div>
         </div>
                           ...
                           <div class="gdlr-core-pbf-element" style="background-color:#800f34;">
                              <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix  gdlr-core-center-align gdlr-core-title-item-caption-top gdlr-core-item-pdlr" style="padding-bottom: 15px; padding-top:15px;">
                                 <div class="gdlr-core-title-item-title-wrap clearfix">
                                    <h3 class="gdlr-core-title-item-title gdlr-core-skin-title " style="font-size: 26px ;font-weight: 600 ;letter-spacing: 0px ;text-transform: none ;color: #ffffff;margin-right: 30px;">Inauguración: <?php echo obtenerFechaInauguracion("Maestría en Gestión Hospitalaria OnLine");?></h3>                                    
                                 </div>
                              </div>
                           </div>
                           ...
                           <div class="gdlr-core-pbf-element">
                              <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align">
                                 <div class="gdlr-core-text-box-item-content" style="font-size: 16px ;text-transform: none ;">
                                    <p>La Maestría en Gestión Hospitalaria está dirigido a profesionales de tercer nivel de grado preferentemente
                                    con títulos afines al campo específico de la Educación comercial y administración. Para los campos de
                                    Tecnologías de la Información y Comunicación (TIC), Salud, Ciencias Sociales, Construcción, Derecho,
                                    Industria, Finanzas, Contabilidad, se solicita al menos 1 año de experiencia profesional en el área del
                                    programa.</p>
                                          ...
                                          <div class="gdlr-core-column-service-item gdlr-core-item-pdb  gdlr-core-left-align gdlr-core-column-service-icon-left gdlr-core-with-caption gdlr-core-item-pdlr" style="padding-bottom: 30px;">
                                             ...
                                             <div class="gdlr-core-column-service-content-wrapper">
                                                <div class="gdlr-core-column-service-title-wrap">
                                                   ...
                                                   <div class="gdlr-core-column-service-caption gdlr-core-info-font gdlr-core-skin-caption" style="font-size: 15px ;font-weight: 500 ;font-style: normal ;">Magíster en Gestión Hospitalaria</div>
                                                </div>
                                             </div>
                                          </div>
                                       </div>
                              ...
                              <div class="textwidget" style="box-shadow: 0 -6px 24px rgba(10, 10, 10,0.09); -moz-box-shadow: 0 -6px 24px rgba(10, 10, 10,0.09); -webkit-box-shadow: 0 -6px 24px rgba(10, 10, 10,0.09); background-color: #ffffff ;border-radius:  3px 3px ;-moz-border-radius:  3px 3px ;-webkit-border-radius:  3px 3px ;">
                                 <div class="gdlr-core-widget-box-shortcode " style="color: #821436 ;padding: 25px 5px;background-color: #ffffff ;">
                                    <div class="gdlr-core-widget-box-shortcode-content">
                                       ...
                                       <div class="gdlr-core-pbf-element">
                                          <div id="form-87121"></div>
                                          <script src="https://webservices.uees.edu.ec/formularios/v2/form-embed.js" data-programa-id="871" data-nivel-id="2" data-modalidad-id="1" data-height="900" data-container="form-87121" defer></script>
                                       </div>
                                    </div>
                                 </div>
                              </div>
                     ...
                     <div class="gdlr-core-pbf-column gdlr-core-column-30 gdlr-core-column-first" id="gdlr-core-column-8638">
                        <div class="gdlr-core-pbf-column-content-margin gdlr-core-js  gdlr-core-column-extend-left" data-sync-height="height-2" style="height: 860.461px;">
                           <div class="gdlr-core-pbf-background-wrap">
                              <div class="gdlr-core-pbf-background gdlr-core-parallax gdlr-core-js" style="background-image: url(../images/carreras/maestria-en-gestion-hospitalaria-01.png); background-size: cover; background-position: center center; height: 875.969px; transform: translate(0px, -43.5328px);" data-parallax-speed="0.2"></div>
                           </div>
                              ...
                              <div class="gdlr-core-pbf-element">
                                 <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align">
                                    <div class="gdlr-core-text-box-item-content" style="font-size: 17px ;text-transform: none ;">
                                       <p>El graduado de la Maestría en Gestión Hospitalaria poseerá habilidades avanzadas en la administración
                                          eficiente de instituciones de salud, comprendiendo la planificación estratégica, gestión financiera,
                                          liderazgo de equipos médicos, y la aplicación de tecnologías de la información en entornos hospitalarios.</p>

                                       <p>Además, desarrollará competencias para optimizar la calidad de la atención, mejorar la eficiencia
                                          operativa y enfrentar desafíos éticos y regulatorios. Este profesional estará preparado para liderar de
                                          manera efectiva y contribuir al mejoramiento continuo del sistema de salud.</p>
                                    </div>
                                 </div>
                              </div>
                           </div>
                  ...
                  <div class="gdlr-core-pbf-wrapper-container clearfix gdlr-core-container">
                        ...
                        <div class="gdlr-core-pbf-column-content-margin gdlr-core-js " style="padding: 100px 40px 50px 10px; height: 653.976px;" data-sync-height="height-1" data-sync-height-center="">
                           ...
                           <div class="gdlr-core-pbf-column-content clearfix gdlr-core-js  gdlr-core-sync-height-content">
                              ...
                              <div class="gdlr-core-pbf-element">
                                 <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align">
                                    <div class="gdlr-core-text-box-item-content" style="font-size: 17px ;text-transform: none ;">
                                       <p>El futuro profesional graduado de la maestría en Gestión Hospitalaria contribuirá al mejoramiento de la
                                       calidad de vida al liderar estrategias que optimicen la prestación de servicios de salud. Además, aplicará
                                       enfoques sostenibles para minimizar impactos ambientales en las prácticas hospitalarias. Contribuirá al
                                       desarrollo productivo mediante la eficiente gestión de recursos. Asimismo, fomentará la preservación,
                                       difusión y enriquecimiento de las culturas y saberes al promover la diversidad y la inclusión en entornos de
                                       salud.</p>
                     ...
                     <div class="gdlr-core-pbf-column gdlr-core-column-30" id="gdlr-core-column-36639">
                        <div class="gdlr-core-pbf-column-content-margin gdlr-core-js  gdlr-core-column-extend-right" data-sync-height="height-1" style="height: 653.976px;">
                           <div class="gdlr-core-pbf-background-wrap">
                              <div class="gdlr-core-pbf-background gdlr-core-parallax gdlr-core-js" style="background-image: url(../images/carreras/maestria-en-gestion-hospitalaria-02.png); background-size: cover; background-position: center center; height: 710.762px; transform: translate(0px, -35.625px);" data-parallax-speed="0.2"></div>
                           </div>
                           <div class="gdlr-core-pbf-column-content clearfix gdlr-core-js  gdlr-core-sync-height-content"></div>
                        </div>
                     </div>
                           ...
                           <div class="gdlr-core-pbf-column-content clearfix gdlr-core-js ">
                              <div class="gdlr-core-pbf-element">
                                 <table>
                                    ...
                                    <tr>
                                       <td>Aspectos legales y Sostenibilidad</td>
                                       <td>18</td>
                                    </tr>
                                    <tr>
                                       <td>Tecnologías emergentes para la Salud</td>
                                       <td>18</td>
                                    </tr>
                                    <tr>
                                       <td>Liderazgo, negociación y resolución de conflictos</td>
                                       <td>18</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                       <td>Calidad y Auditoría en la Salud</td>
                                       <td>18</td>
                                    </tr>
                                    <tr>
                                       <td>Gestión estratégica de costos</td>
                                       <td>18</td>
                                    </tr>
                                    <tr>
                                       <td>Gestión por Procesos Hospitalarios</td>
                                       <td>18</td>
                                    </tr>
                                    <tr>
                                       <td>Analítica de negocios, KPI`s y OKRs</td>
                                       <td>18</td>
                                    </tr>
                                    <tr>
                                       <td>Investigación aplicada y trabajo de fin de máster</td>
                                       <td>18</td>
                                    </tr>                                                                    
                                 </table>
                              </div>
