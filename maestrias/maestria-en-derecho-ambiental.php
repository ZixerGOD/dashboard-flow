...
<body class="home page-template-default page page-id-2039 gdlr-core-body woocommerce-no-js tribe-no-js kingster-body kingster-body-front kingster-full  kingster-with-sticky-navigation  kingster-blockquote-style-1 gdlr-core-link-to-lightbox">
   ...
   <div class="kingster-body-outer-wrapper ">
      <div class="kingster-body-wrapper clearfix  kingster-with-frame">
         ...
         <div class="kingster-page-title-wrap  kingster-style-custom kingster-left-align" style="background-image: url(../images/carreras/maestria-en-derecho-ambiental-top.jpg) ;">
            ...
            <div class="kingster-page-title-container kingster-container">
               <div class="kingster-page-title-content kingster-item-pdlr" style="padding-top: 200px ;padding-bottom: 80px ;">
                  ...
                  <h1 class="kingster-page-title" style="text-transform: none ;">Maestr&iacute;a en Derecho Ambiental Con Menci&oacute;n En Sostenibilidad</h1>
               </div>
            </div>
         </div>
                           ...
                           <div class="gdlr-core-pbf-element" style="background-color:#800f34;">
                              <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix  gdlr-core-center-align gdlr-core-title-item-caption-top gdlr-core-item-pdlr" style="padding-bottom: 15px; padding-top:15px;">
                                 <div class="gdlr-core-title-item-title-wrap clearfix">
                                    <h3 class="gdlr-core-title-item-title gdlr-core-skin-title " style="font-size: 26px ;font-weight: 600 ;letter-spacing: 0px ;text-transform: none ;color: #ffffff;margin-right: 30px;">Inauguración: <?php echo obtenerFechaInauguracion("Maestria en Derecho Ambiental OnLine");?></h3>                                    
                                 </div>
                              </div>
                           </div>
                           ...
                           <div class="gdlr-core-pbf-element">
                              <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align">
                                 <div class="gdlr-core-text-box-item-content" style="font-size: 16px ;text-transform: none ;">
                                    <p>La Maestría en Derecho Ambiental con mención en Sostenibilidad 100% en línea está dirigida a profesionales
                                        con título universitario de tercer nivel de grado en los campos de: del derecho, ciencias políticas, sociología,
                                        ingeniería ambiental o afines, cuyo ámbito de acción o aspiraciones profesionales giren en torno al
                                        desarrollo sostenible, la gestión de recursos naturales, producción y responsabilidad social. Además,
                                        deberá: Tener una formación académica integral sólida, consistente en los conocimientos propios en el
                                        ámbito de las ciencias jurídicas; mostrar capacidad de análisis y síntesis; acreditar capacidad lectora y
                                        comprensión oral de una lengua extranjera (inglés, A2), que permitan la lectura y evaluación de la
                                        bibliografía pertinente para el desarrollo del programa; experiencia profesional o de investigación, de por
                                        lo menos 1 año; demostrar capacidad de análisis de textos, acompañado de habilidades de lectura y
                                          ...
                                          <div class="gdlr-core-column-service-item gdlr-core-item-pdb  gdlr-core-left-align gdlr-core-column-service-icon-left gdlr-core-with-caption gdlr-core-item-pdlr" style="padding-bottom: 30px;">
                                             ...
                                             <div class="gdlr-core-column-service-content-wrapper">
                                                <div class="gdlr-core-column-service-title-wrap">
                                                   ...
                                                   <div class="gdlr-core-column-service-caption gdlr-core-info-font gdlr-core-skin-caption" style="font-size: 15px ;font-weight: 500 ;font-style: normal ;">Mag&iacute;ster en Derecho Ambiental con menci&oacute;n en Sostenibilidad</div>
                                                </div>
                                             </div>
                                          </div>
                                       </div>
                                          ...
                                          <div class="gdlr-core-column-service-item gdlr-core-item-pdb  gdlr-core-left-align gdlr-core-column-service-icon-left gdlr-core-with-caption gdlr-core-item-pdlr" style="padding-bottom: 30px;">
                                             ...
                                             <div class="gdlr-core-column-service-content-wrapper">
                                                <div class="gdlr-core-column-service-title-wrap">
                                                   ...
                                                   <div class="gdlr-core-column-service-caption gdlr-core-info-font gdlr-core-skin-caption" style="font-size: 15px ;font-weight: 500 ;font-style: normal ;">RPC-SO-02-No.038-2022</div>
                                                </div>
                                             </div>
                                          </div>
                                       </div>
                              ...
                              <div class="textwidget" style="box-shadow: 0 -6px 24px rgba(10, 10, 10,0.09); -moz-box-shadow: 0 -6px 24px rgba(10, 10, 10,0.09); -webkit-box-shadow: 0 -6px 24px rgba(10, 10, 10,0.09); background-color: #ffffff ;border-radius:  3px 3px ;-moz-border-radius:  3px 3px ;-webkit-border-radius:  3px 3px ;">
                                 <div class="gdlr-core-widget-box-shortcode " style="color: #821436 ;padding: 25px 5px;background-color: #ffffff ;">
                                    <div class="gdlr-core-widget-box-shortcode-content">
                                       ...
                                       <div class="gdlr-core-pbf-element">
                                          <div id="form-80221"></div>
                                          <script src="https://webservices.uees.edu.ec/formularios/v2/form-embed.js" data-programa-id="802" data-nivel-id="2" data-modalidad-id="1" data-height="900" data-container="form-80221" defer></script>
                                       </div>
                                    </div>
                                 </div>
                              </div>
                     ...
                     <div class="gdlr-core-pbf-column gdlr-core-column-30 gdlr-core-column-first" id="gdlr-core-column-8638">
                        <div class="gdlr-core-pbf-column-content-margin gdlr-core-js  gdlr-core-column-extend-left" data-sync-height="height-2" style="height: 860.461px;">
                           <div class="gdlr-core-pbf-background-wrap">
                              <div class="gdlr-core-pbf-background gdlr-core-parallax gdlr-core-js" style="background-image: url(../images/carreras/maestria-en-derecho-ambiental-01.jpg); background-size: cover; background-position: center center; height: 875.969px; transform: translate(0px, -43.5328px);" data-parallax-speed="0.2"></div>
                           </div>
                              ...
                              <div class="gdlr-core-pbf-element">
                                 <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align">
                                    <div class="gdlr-core-text-box-item-content" style="font-size: 17px ;text-transform: none ;">
                                       <p>Entregar las herramientas jurídicas ambientales, de esta manera responder a los retos ambientales, a
                                            través de soluciones jurídicas innovadoras, eficaces y eficientes, bajo un enfoque de sostenibilidad. Todo
                                            ello con el propósito de transformar la dinámica jurídica que ve a la naturaleza como un objeto, y permitir
                                            que sea considerada como un sujeto de derecho con el propósito de garantizar un ambiente sano en
                                            armonía con los seres humanos.
                                       </p>
                                    </div>
                                 </div>
                              </div>
                  ...
                  <div class="gdlr-core-pbf-wrapper-container clearfix gdlr-core-container">
                                       ...
                                       <ul>
                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                                                <span class="gdlr-core-icon-list-content" style="font-size: 16px;">Asesorar y aconsejar legalmente a empresas públicas, privadas u organizaciones del tercer sector, desde un enfoque basado en la sostenibilidad de los recursos, buscando la mediación ambiental como factor fundamental para la solución de conflictos socioambientales.</span>
                                             </div>
                                          </li>
                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                                                <span class="gdlr-core-icon-list-content" style="font-size: 16px;">Reflexionar acerca de los principales problemas ambientales y estratégicos que atraviesa el país y la región, y ofrecer soluciones</span>
                                             </div>
                                          </li>
                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                                                <span class="gdlr-core-icon-list-content" style="font-size: 16px;">Poseer la capacidad para diagnosticar, diseñar, implementar y evaluar estrategias de defensa técnica de los sectores estratégicos a la luz de los principios de la sostenibilidad (ambiental, económico y social), sostenibilidad.</span>
                                             </div>
                                          </li>                                        
                                       </ul>
                                    </div>
                     ...
                     <div class="gdlr-core-pbf-column gdlr-core-column-30" id="gdlr-core-column-36639">
                        <div class="gdlr-core-pbf-column-content-margin gdlr-core-js  gdlr-core-column-extend-right" data-sync-height="height-1" style="height: 653.976px;">
                           <div class="gdlr-core-pbf-background-wrap">
                              <div class="gdlr-core-pbf-background gdlr-core-parallax gdlr-core-js" style="background-image: url(../images/carreras/maestria-en-derecho-ambiental-02.jpg); background-size: cover; background-position: center center; height: 710.762px; transform: translate(0px, -35.625px);" data-parallax-speed="0.2"></div>
                           </div>
                           <div class="gdlr-core-pbf-column-content clearfix gdlr-core-js  gdlr-core-sync-height-content"></div>
                        </div>
                     </div>
                              ...
                              <div class="gdlr-core-pbf-element">
                                 <table>
                                    ...
                                    <tr style="background-color: #ffffff">
                                       <td>Derecho Constitucional Ambiental</td>
                                       <td>18</td>
                                    </tr>
                                    <tr>
                                       <td>Derecho de Aguas</td>
                                       <td>18</td>
                                    </tr>
                                    <tr>
                                       <td>Derecho y Cambio Climático</td>
                                       <td>18</td>
                                    </tr>
                                    <tr>
                                       <td>Teoría General del Derecho Ambiental</td>
                                       <td>18</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                       <td>Calidad y Gestión Ambiental</td>
                                       <td>18</td>
                                    </tr>
                                    <tr>
                                       <td>Derecho Minero e Hidrocarburos</td>
                                       <td>18</td>
                                    </tr>
                                    <tr>
                                       <td>Derecho Penal Ambiental y régimen de infracciones administrativas</td>
                                       <td>18</td>
                                    </tr>
                                    <tr>
                                       <td>Régimen tributario e incentivos ambientales</td>
                                       <td>18</td>
                                    </tr>
                                    <tr>
                                       <td>Titulación</td>
