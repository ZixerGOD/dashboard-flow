...
<body class="home page-template-default page page-id-2039 gdlr-core-body woocommerce-no-js tribe-no-js kingster-body kingster-body-front kingster-full  kingster-with-sticky-navigation  kingster-blockquote-style-1 gdlr-core-link-to-lightbox">
   ...
   <div class="kingster-body-outer-wrapper ">
      <div class="kingster-body-wrapper clearfix  kingster-with-frame">
         ...
         <div class="kingster-page-title-wrap  kingster-style-custom kingster-left-align" style="background-image: url(../images/carreras/maestria-en-gestion-educativa-top.jpg) ;">
            ...
            <div class="kingster-page-title-container kingster-container">
               <div class="kingster-page-title-content kingster-item-pdlr" style="padding-top: 200px ;padding-bottom: 80px ;">
                  ...
                  <h1 class="kingster-page-title" style="text-transform: none ;">Maestr&iacute;a en Gesti&oacute;n Educativa</h1>
               </div>
            </div>
         </div>
                           ...
                           <div class="gdlr-core-pbf-element" style="background-color:#800f34;">
                              <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix  gdlr-core-center-align gdlr-core-title-item-caption-top gdlr-core-item-pdlr" style="padding-bottom: 15px; padding-top:15px;">
                                 <div class="gdlr-core-title-item-title-wrap clearfix">
                                    <h3 class="gdlr-core-title-item-title gdlr-core-skin-title " style="font-size: 26px ;font-weight: 600 ;letter-spacing: 0px ;text-transform: none ;color: #ffffff;margin-right: 30px;">Obtén tu doble titulación con GFU</h3><br>   
                                    <h3 class="gdlr-core-title-item-title gdlr-core-skin-title " style="font-size: 26px ;font-weight: 600 ;letter-spacing: 0px ;text-transform: none ;color: #ffffff;margin-right: 30px;">Inauguración: Junio 22, 2026</h3>                                    
                                 </div>
                              </div>
                           </div>
                           <div class="gdlr-core-pbf-element" style="padding-top: 10px;">
                                 <div class="gdlr-core-image-item gdlr-core-item-pdb gdlr-core-center-align gdlr-core-item-pdlr">
                                    <div class="gdlr-core-image-item-wrap gdlr-core-media-image  gdlr-core-image-item-style-rectangle" style="border-width: 0px;margin: 0px 0px 0px 0px;">
                                       <picture>
                                          <source type="image/webp" data-srcset="https://online.uees.edu.ec/upload/flag-globaltech-florida.png">
                                          <a href="https://globaltechflorida.university/" target="_blank"><img class="lazy loaded" src="https://online.uees.edu.ec/upload/flag-globaltech-florida.png" data-src="https://online.uees.edu.ec/upload/flag-globaltech-florida.png" width="515" height="184" data-srcset="https://online.uees.edu.ec/upload/flag-globaltech-florida.png 400w, https://online.uees.edu.ec/upload/flag-globaltech-florida.png 600w, https://online.uees.edu.ec/upload/flag-globaltech-florida.png 800w, https://online.uees.edu.ec/upload/flag-globaltech-florida.png 930w" data-sizes="(max-width: 767px) 100vw, (max-width: 1150px) 60vw, 690px" alt="" sizes="(max-width: 767px) 100vw, (max-width: 1150px) 60vw, 690px" srcset="https://online.uees.edu.ec/upload/flag-globaltech-florida.png 400w, https://online.uees.edu.ec/upload/flag-globaltech-florida.png 600w, https://online.uees.edu.ec/upload/flag-globaltech-florida.png 800w, https://online.uees.edu.ec/upload/flag-globaltech-florida.png 930w" data-was-processed="true"></a>
                                       </picture>
                                    </div>
                                 </div>
                            </div>
                           ...
                           <div class="gdlr-core-pbf-element">
                              <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align">
                                 <div class="gdlr-core-text-box-item-content" style="font-size: 16px ;text-transform: none ;">
                                    <p>La Maestría en Gestión Educativa 100% en línea está dirigida a profesionales con título de tercer nivel de
                                       grado en cualquier área del conocimiento, debidamente registrado en SENESCYT.
                                    </p>
                                    <p><strong>Duraci&oacute;n De Programa:</strong> 12 Meses</p>
                                    <p><strong>Tutorías sincrónicas: </strong> sábados de 08:00 – 13:00</p>
                                          ...
                                          <div class="gdlr-core-column-service-item gdlr-core-item-pdb  gdlr-core-left-align gdlr-core-column-service-icon-left gdlr-core-with-caption gdlr-core-item-pdlr" style="padding-bottom: 30px;">
                                             ...
                                             <div class="gdlr-core-column-service-content-wrapper">
                                                <div class="gdlr-core-column-service-title-wrap">
                                                   <h3 class="gdlr-core-column-service-title gdlr-core-skin-title" style="font-size: 18px ;font-weight: 600 ;text-transform: none ;color: #161616">Títulos a obtener</h3>
                                                   <div class="gdlr-core-column-service-caption gdlr-core-info-font gdlr-core-skin-caption" style="font-size: 15px ;font-weight: 500 ;font-style: normal ;">Mag&iacute;ster en Gesti&oacute;n Educativa, Universidad Espíritu Santo, Ecuador.</div>
                                                   <div class="gdlr-core-column-service-caption gdlr-core-info-font gdlr-core-skin-caption" style="font-size: 15px ;font-weight: 500 ;font-style: normal ;">Master of Science in Educational Management: Major in Instructional Design and Digital Innovation in Virtual Learning Environment, GFU, Estados Unidos.</div>
                                                </div>
                                             </div>
                                          </div>
                                       </div>
                                          ...
                                          <div class="gdlr-core-column-service-item gdlr-core-item-pdb  gdlr-core-left-align gdlr-core-column-service-icon-left gdlr-core-with-caption gdlr-core-item-pdlr" style="padding-bottom: 30px;">
                                             ...
                                             <div class="gdlr-core-column-service-content-wrapper">
                                                <div class="gdlr-core-column-service-title-wrap">
                                                   ...
                                                   <div class="gdlr-core-column-service-caption gdlr-core-info-font gdlr-core-skin-caption" style="font-size: 15px ;font-weight: 500 ;font-style: normal ;">RPC-SO-22-NO.560-2021</div>
                                                </div>
                                             </div>
                                          </div>
                                       </div>
                              ...
                              <div class="textwidget" style="box-shadow: 0 -6px 24px rgba(10, 10, 10,0.09); -moz-box-shadow: 0 -6px 24px rgba(10, 10, 10,0.09); -webkit-box-shadow: 0 -6px 24px rgba(10, 10, 10,0.09); background-color: #ffffff ;border-radius:  3px 3px ;-moz-border-radius:  3px 3px ;-webkit-border-radius:  3px 3px ;">
                                 <div class="gdlr-core-widget-box-shortcode " style="color: #821436 ;padding: 25px 5px;background-color: #ffffff ;">
                                    <div class="gdlr-core-widget-box-shortcode-content">
                                       ...
                                       <div class="gdlr-core-pbf-element">
                                          <div id="form-73821"></div>
                                          <script src="https://webservices.uees.edu.ec/formularios/v2/form-embed.js" data-programa-id="738" data-nivel-id="2" data-modalidad-id="1" data-height="900" data-container="form-73821" defer></script>
                                       </div>
                                    </div>
                                 </div>
                              </div>
                     ...
                     <div class="gdlr-core-pbf-column gdlr-core-column-30 gdlr-core-column-first" id="gdlr-core-column-8638">
                        <div class="gdlr-core-pbf-column-content-margin gdlr-core-js  gdlr-core-column-extend-left" data-sync-height="height-2" style="height: 860.461px;">
                           <div class="gdlr-core-pbf-background-wrap">
                              <div class="gdlr-core-pbf-background gdlr-core-parallax gdlr-core-js" style="background-image: url(../images/carreras/maestria-en-gestion-educativa-01.jpg); background-size: cover; background-position: center center; height: 875.969px; transform: translate(0px, -43.5328px);" data-parallax-speed="0.2"></div>
                           </div>
                                       ...
                                       <ul>
                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                                                <span class="gdlr-core-icon-list-content" style="font-size: 16px;text-align: justify;">Discernir, valorar y aplicar las teorías de liderazgo y gerencia educativos, así como los procedimientos e
                                                instrumentos concomitantes en los diferentes ámbitos de gestión educativa.</span>
                                             </div>
                                          </li>
                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                                                <span class="gdlr-core-icon-list-content" style="font-size: 16px;text-align: justify;">Adecuar los procesos de la gestión educativa a las políticas y planes de desarrollo nacionales.</span>
                                             </div>
                                          </li>
                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                                                <span class="gdlr-core-icon-list-content" style="font-size: 16px;text-align: justify;">Capacidad de adaptación a nuevas situaciones.</span>
                                             </div>
                                          </li>
                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                                                <span class="gdlr-core-icon-list-content" style="font-size: 16px;text-align: justify;">Producir saberes articulados a los planes y programas de la nación y que procedan de la formación de la
                                                práctica y la experiencia vinculadas como referente de la gestión educativa.</span>
                                             </div>
                                          </li>
                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                                                <span class="gdlr-core-icon-list-content" style="font-size: 16px;text-align: justify;">Desarrollar nuevas competencias de gestión educativa.</span>
                                             </div>
                                          </li>
                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                                                <span class="gdlr-core-icon-list-content" style="font-size: 16px;text-align: justify;">Forjar recursos de gestión educativa, financieros y de evaluación integral e integrada de todos los
                                                procesos y sus productos.</span>
                                             </div>
                                          </li>
                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                                                <span class="gdlr-core-icon-list-content" style="font-size: 16px;text-align: justify;">Considerar a la interculturalidad como una dimensión básica de la educación general de los individuos,
                                                los grupos y las comunidades, adoptar actitudes y prácticas que coadyuven mejorar la comunicación
                                                entre personas de diversas culturas.</span>
                                             </div>
                                          </li>
                                       </ul>
                                    </div>
                  ...
                  <div class="gdlr-core-pbf-wrapper-container clearfix gdlr-core-container">
                                 ...
                                 <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align">
                                    <div class="gdlr-core-text-box-item-content" style="font-size: 17px ;text-transform: none ;">
                                       <ul>
                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                                                <span class="gdlr-core-icon-list-content" style="font-size: 16px;text-align: justify;">Conocer los enfoques del pensamiento gerencial moderno y sus implicaciones en el desarrollo organizacional en el ámbito educativo.</span>
                                             </div>
                                          </li>
                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                                                <span class="gdlr-core-icon-list-content" style="font-size: 16px;text-align: justify;">Reconocer las necesidades de planicación, evaluación y comunicación asertiva, como una orientación
                                                estratégica hacia la mejora continua y la innovación.</span>
                                             </div>
                                          </li>
                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                                                <span class="gdlr-core-icon-list-content" style="font-size: 16px;text-align: justify;">Generar procesos de investigación en el ámbito educativo.</span>
                                             </div>
                                          </li>
                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                                                <span class="gdlr-core-icon-list-content" style="font-size: 16px;text-align: justify;">Comprender e interpretar el marco legal y las normas generales de organización para el buen
                                                funcionamiento del centro en sus aspectos educativos, económicos y de gestión de los recursos
                                                humanos y materiales.</span>
                                             </div>
                                          </li>
                                       </ul>
                                    </div>
                     ...
                     <div class="gdlr-core-pbf-column gdlr-core-column-30" id="gdlr-core-column-36639">
                        <div class="gdlr-core-pbf-column-content-margin gdlr-core-js  gdlr-core-column-extend-right" data-sync-height="height-1" style="height: 653.976px;">
                           <div class="gdlr-core-pbf-background-wrap">
                              <div class="gdlr-core-pbf-background gdlr-core-parallax gdlr-core-js" style="background-image: url(../images/carreras/maestria-en-gestion-educativa-02.jpg); background-size: cover; background-position: center center; height: 710.762px; transform: translate(0px, -35.625px);" data-parallax-speed="0.2"></div>
                           </div>
                           <div class="gdlr-core-pbf-column-content clearfix gdlr-core-js  gdlr-core-sync-height-content"></div>
                        </div>
                     </div>
                                 ...
                                 <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align" style="padding-bottom: 15px ;">
                                    <div class="gdlr-core-text-box-item-content" style="font-size: 16px ;text-transform: none ;color: #6b6b6b;">
                                       <ol>
                                          ...
                                          <li>Realizar la entrevista con el director y/o coordinador  del programa de maestría</li>
                                       </ol>
                                    </div>
                                 </div>
                              </div>
                              ...
                              <div class="gdlr-core-pbf-element">
                                 <table>
                                    ...
                                    <tr style="background-color: #ffffff">
                                       <td >Habilidades interpersonales</td>
                                       <td>6</td>
                                    </tr>
                                    <tr>
                                       <td>Dise&ntilde;o y desarrollo curricular</td>
                                       <td>18</td>
                                    </tr>
                                    <tr>
                                       <td>Sistema educativo ecuatoriano, políticas y legislación</td>
                                       <td>18</td>
                                    </tr>
                                    <tr>
                                       <td>Inclusión educativa</td>
                                       <td>18</td>
                                    </tr>
                                    <tr>
                                       <td>Tendencias educativa y cultura global</td>
                                       <td>18</td>
                                    </tr>
                                    <tr>
                                       <td>Titulación I: Metodología de la investigación</td>
                                       <td>18</td>
                                    </tr>
                                    <tr>
                                       <td>Formulación y evaluación de proyectos educativos</td>
                                       <td>18</td>
                                    </tr>
                                    <tr>
                                       <td>Fundamentos de administración educativa</td>
                                       <td>18</td>
                                    </tr>
                                    <tr>
                                       <td>Fundamentos de gestión educativa</td>
                                       <td>18</td>
                                    </tr>
                                    <tr>
                                       <td>Planificación estratégica y desarrollo de las organizaciones educativas</td>
                                       <td>18</td>
                                    </tr>
                                    <tr>
                                       <td>Titulación II: Trabajo de Titulación</td>
                                       <td>18</td>
                                    </tr>
                                 </table>
                              </div>
