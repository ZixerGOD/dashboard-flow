...
<body class="home page-template-default page page-id-2039 gdlr-core-body woocommerce-no-js tribe-no-js kingster-body kingster-body-front kingster-full  kingster-with-sticky-navigation  kingster-blockquote-style-1 gdlr-core-link-to-lightbox">
   ...
   <div class="kingster-body-outer-wrapper ">
      <div class="kingster-body-wrapper clearfix  kingster-with-frame">
         ...
         <div class="kingster-page-title-wrap  kingster-style-custom kingster-left-align" style="background-image: url(../images/carreras/maestria-en-banca-y-gestion-de-mercados-financieros-top.jpg) ;">
            ...
            <div class="kingster-page-title-container kingster-container">
               <div class="kingster-page-title-content kingster-item-pdlr" style="padding-top: 200px ;padding-bottom: 80px ;">
                  ...
                  <h1 class="kingster-page-title" style="text-transform: none ;">Maestr&iacute;a en Banca y Gesti&oacute;n de Mercados Financieros</h1>
               </div>
            </div>
         </div>
                           ...
                           <div class="gdlr-core-pbf-element" style="background-color:#800f34;">
                              <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix  gdlr-core-center-align gdlr-core-title-item-caption-top gdlr-core-item-pdlr" style="padding-bottom: 15px; padding-top:15px;">
                                 <div class="gdlr-core-title-item-title-wrap clearfix">
                                    <h3 class="gdlr-core-title-item-title gdlr-core-skin-title " style="font-size: 26px ;font-weight: 600 ;letter-spacing: 0px ;text-transform: none ;color: #ffffff;margin-right: 30px;">Inauguración: <?php echo obtenerFechaInauguracion("Maestria en Banca y Gestion de Mercados Financieros OnLine");?></h3>                                    
                                 </div>
                              </div>
                           </div>
                           ...
                           <div class="gdlr-core-pbf-element">
                              <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align">
                                 <div class="gdlr-core-text-box-item-content" style="font-size: 16px ;text-transform: none ;">
                                    <p>Dirigido a profesionales de tercer nivel de grado con títulos de Ingenieros, licenciados; preferentemente afines al campo de Administración, para los campos de Educación, Ciencias Sociales, Periodismo, Información y Derecho, Tecnologías de la Información y comunicación (TIC), Ingeniería, Industria y Construcción, Salud y Bienestar (medicina) se solicita 1 año de experiencia profesional afín al programa.</p>
                                          ...
                                          <div class="gdlr-core-column-service-item gdlr-core-item-pdb  gdlr-core-left-align gdlr-core-column-service-icon-left gdlr-core-with-caption gdlr-core-item-pdlr" style="padding-bottom: 30px;">
                                             ...
                                             <div class="gdlr-core-column-service-content-wrapper">
                                                <div class="gdlr-core-column-service-title-wrap">
                                                   ...
                                                   <div class="gdlr-core-column-service-caption gdlr-core-info-font gdlr-core-skin-caption" style="font-size: 15px ;font-weight: 500 ;font-style: normal ;">Mag&iacute;ster en Banca y Gesti&oacute;n de Mercados Financieros</div>
                                                </div>
                                             </div>
                                          </div>
                                       </div>
                              ...
                              <div class="textwidget" style="box-shadow: 0 -6px 24px rgba(10, 10, 10,0.09); -moz-box-shadow: 0 -6px 24px rgba(10, 10, 10,0.09); -webkit-box-shadow: 0 -6px 24px rgba(10, 10, 10,0.09); background-color: #ffffff ;border-radius:  3px 3px ;-moz-border-radius:  3px 3px ;-webkit-border-radius:  3px 3px ;">
                                 <div class="gdlr-core-widget-box-shortcode " style="color: #821436 ;padding: 25px 5px;background-color: #ffffff ;">
                                    <div class="gdlr-core-widget-box-shortcode-content">
                                       ...
                                       <div class="gdlr-core-pbf-element">
                                          <div id="form-72621"></div>
                                          <script src="https://webservices.uees.edu.ec/formularios/v2/form-embed.js" data-programa-id="726" data-nivel-id="2" data-modalidad-id="1" data-height="900" data-container="form-72621" defer></script>
                                       </div>
                                    </div>
                                 </div>
                              </div>
                              ...
                              <div class="gdlr-core-pbf-element">
                                 <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align">
                                    <div class="gdlr-core-text-box-item-content" style="font-size: 17px ;text-transform: none ;">
                                       <p>El objetivo general de la Maestría en Banca y Gestión de Mercados Financieros es dotar de conocimientos a los estudiantes para que puedan desarrollar habilidades financieras para el proceso de decisión. La maestría de Banca y Gestión de Mercados Financieros de la UEES formará profesionales con responsabilidad social, económica y tecnológica capaces de analizar bajo el análisis de información los diversos escenarios ante los cuales deba tomar decisiones financieras. La maestría formará profesionales capaces de analizar el entorno externo y competitivo donde se desenvuelva la empresa, formular e implantar datos para que las empresas ecuatorianas se desarrollen exitosamente a través de la gestión financiera y control de riesgo. El master será capaz de gestionar, modelar y desarrollar soluciones integrales a problemas vinculados a su disciplina a través de sólidos fundamentos teóricos y prácticos que conlleve a visualizar nuevos enfoques para expandir el desarrollo de las innovaciones financieras en el mercado. Para esto, se enseñará a utilizar prácticas honestas, uso eficiente de los recursos, inclusión social de las personas e incentivar la cooperación con empresas latinoamericanas y globales. La maestría de Banca y Gestión de Mercados Financieros fomentará la educación, formación, entrenamiento e investigación aplicada con un enfoque inclusivo, ético y humanístico. Finalmente, los nuevos egresados de la maestría de Banca y Gestión de Mercados Financieros están llamados a transformar el sector empresarial ecuatoriano en concordancia con el cambio de la cuarta revolución industrial.</p>
                                    </div>
                                 </div>
                              </div>
                           </div>
                  ...
                  <div class="gdlr-core-pbf-wrapper-container clearfix gdlr-core-container">
                                       ...
                                       <ul>
                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                                                <span class="gdlr-core-icon-list-content" style="font-size: 16px;">Desarrollar competencias técnicas, estratégicas y metodológicas para enfrentar desafíos financieros en el ámbito bancario y de los mercados, con criterio ético, enfoque sostenible y responsabilidad social.</span>
                                             </div>
                                          </li>
                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                                                <span class="gdlr-core-icon-list-content" style="font-size: 16px;">Formular soluciones financieras innovadoras, planes de inversión y estrategias de gestión orientadas a fortalecer la rentabilidad y sostenibilidad de organizaciones públicas y privadas en entornos cambiantes.</span>
                                             </div>
                                          </li>
                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                                                <span class="gdlr-core-icon-list-content" style="font-size: 16px;">Evaluar información financiera y económica proveniente de distintas fuentes y contextos, utilizando herramientas cuantitativas y tecnologías digitales que permitan optimizar la toma de decisiones.</span>
                                             </div>
                                          </li>                                          
                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                                                <span class="gdlr-core-icon-list-content" style="font-size: 16px;">Fomentar el liderazgo colaborativo, la negociación efectiva y la gestión de equipos diversos, impulsando la transformación organizacional con inclusión, respeto por la diversidad y conciencia ambiental</span>
                                             </div>
                                          </li>                                          
                                       </ul>
                                    </div>
                     ...
                     <div class="gdlr-core-pbf-column gdlr-core-column-30" id="gdlr-core-column-36639">
                        <div class="gdlr-core-pbf-column-content-margin gdlr-core-js  gdlr-core-column-extend-right" data-sync-height="height-1" style="height: 653.976px;">
                           <div class="gdlr-core-pbf-background-wrap">
                              <div class="gdlr-core-pbf-background gdlr-core-parallax gdlr-core-js" style="background-image: url(../images/carreras/maestria-en-banca-y-gestion-de-mercados-financieros-02.jpg); background-size: cover; background-position: center center; height: 710.762px; transform: translate(0px, -35.625px);" data-parallax-speed="0.2"></div>
                           </div>
                           <div class="gdlr-core-pbf-column-content clearfix gdlr-core-js  gdlr-core-sync-height-content"></div>
                        </div>
                     </div>
                           ...
                           <div class="gdlr-core-pbf-column-content clearfix gdlr-core-js ">
                              <div class="gdlr-core-pbf-element">
                                 <table>
                                    ...
                                    <tr>
                                       <td>Análisis Contable y Financiero </td>
                                       <td>12</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                       <td>Gestión Estratégica Bancaria. Innovación y Tics</td>
                                       <td>12</td>
                                    </tr>
                                    <tr>
                                       <td>Marco Regulatorio Nacional e Internacional</td>
                                       <td>12</td>
                                    </tr>
                                    <tr>
                                       <td>Moneda, Banca y Mercados Financieros</td>
                                       <td>12</td>
                                    </tr>
                                    <tr>
                                       <td>Proyecto integrador en Banca y Gestión de Mercados Financieros</td>
                                       <td>12</td>
                                    </tr>                                    
                                 </table>
                              </div>
