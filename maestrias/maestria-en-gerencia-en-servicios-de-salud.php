...
<body class="home page-template-default page page-id-2039 gdlr-core-body woocommerce-no-js tribe-no-js kingster-body kingster-body-front kingster-full  kingster-with-sticky-navigation  kingster-blockquote-style-1 gdlr-core-link-to-lightbox">
   ...
   <div class="kingster-body-outer-wrapper ">
      <div class="kingster-body-wrapper clearfix  kingster-with-frame">
         ...
         <div class="kingster-page-title-wrap  kingster-style-custom kingster-left-align" style="background-image: url(../images/carreras/maestria-en-gerencia-en-servicios-de-salud-top.jpg) ;">
            ...
            <div class="kingster-page-title-container kingster-container">
               <div class="kingster-page-title-content kingster-item-pdlr" style="padding-top: 200px ;padding-bottom: 80px ;">
                  ...
                  <h1 class="kingster-page-title" style="text-transform: none ;">Maestr&iacute;a en Gerencia en Servicios de la Salud</h1>
               </div>
            </div>
         </div> 
                           ...
                           <div class="gdlr-core-pbf-element" style="background-color:#800f34;">
                              <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix  gdlr-core-center-align gdlr-core-title-item-caption-top gdlr-core-item-pdlr" style="padding-bottom: 15px; padding-top:15px;">
                                 <div class="gdlr-core-title-item-title-wrap clearfix">
                                    ...
                                    <h3 class="gdlr-core-title-item-title gdlr-core-skin-title " style="font-size: 18px ;font-weight: 600 ;letter-spacing: 0px ;text-transform: none ;color: #ffffff;margin-right: 30px;">Inauguración: Abril 6, 2026</h3>                                    
                                 </div>
                              </div>
                           </div>
                           ...
                           <div class="gdlr-core-pbf-element">
                              <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align">
                                 <div class="gdlr-core-text-box-item-content" style="font-size: 16px ;text-transform: none ;">
                                    <p>La Maestría en Gerencia en Servicios de la Salud 100% en línea está dirigida a profesionales de título de
                                        tercer nivel de grado debidamente registrado, preferentemente en el campo de Administración; Ciencias
                                        Sociales; Periodismo; Información; Derecho; Salud y Bienestar. Para profesionales con título de tercer nivel
                                        en otros campos de conocimiento se debe acreditar experiencia en cargos administrativos o gerenciales en
                                        instituciones de la salud (mínimo 1 año).</p>
                                    <p><strong>Duraci&oacute;n De Programa:</strong> 12 Meses</p>
                                    <p><strong>Tutorías sincrónicas: </strong> Sábado (mañana o tarde) </p>
                                 </div>
                                          ...
                                          <div class="gdlr-core-column-service-item gdlr-core-item-pdb  gdlr-core-left-align gdlr-core-column-service-icon-left gdlr-core-with-caption gdlr-core-item-pdlr" style="padding-bottom: 30px;">
                                             ...
                                             <div class="gdlr-core-column-service-content-wrapper">
                                                <div class="gdlr-core-column-service-title-wrap">
                                                   ...
                                                   <div class="gdlr-core-column-service-caption gdlr-core-info-font gdlr-core-skin-caption" style="font-size: 15px ;font-weight: 500 ;font-style: normal ;">Mag&iacute;ster en Gerencia en Servicios de la Salud, UEES, Ecuador.</div>
                                                   
                                                   <div class="gdlr-core-column-service-caption gdlr-core-info-font gdlr-core-skin-caption" style="font-size: 15px ;font-weight: 500 ;font-style: normal ;">Master of Business Administration: Major in Strategic Healthcare Management, GFU.</div>
                                                </div>
                                             </div>
                                          </div>
                                       </div>
                                          ...
                                          <div class="gdlr-core-column-service-item gdlr-core-item-pdb  gdlr-core-left-align gdlr-core-column-service-icon-left gdlr-core-with-caption gdlr-core-item-pdlr" style="padding-bottom: 30px;">
                                             ...
                                             <div class="gdlr-core-column-service-content-wrapper">
                                                <div class="gdlr-core-column-service-title-wrap">
                                                   ...
                                                   <div class="gdlr-core-column-service-caption gdlr-core-info-font gdlr-core-skin-caption" style="font-size: 15px ;font-weight: 500 ;font-style: normal ;">RPC-SO-22-No.350-2022</div>
                                                </div>
                                             </div>
                                          </div>
                                       </div>
                              ...
                              <div class="textwidget" style="box-shadow: 0 -6px 24px rgba(10, 10, 10,0.09); -moz-box-shadow: 0 -6px 24px rgba(10, 10, 10,0.09); -webkit-box-shadow: 0 -6px 24px rgba(10, 10, 10,0.09); background-color: #ffffff ;border-radius:  3px 3px ;-moz-border-radius:  3px 3px ;-webkit-border-radius:  3px 3px ;">
                                 <div class="gdlr-core-widget-box-shortcode " style="color: #821436 ;padding: 25px 5px;background-color: #ffffff ;">
                                    <div class="gdlr-core-widget-box-shortcode-content">
                                       ...
                                       <div class="gdlr-core-pbf-element">
                                          <div id="form-81021"></div>
                                          <script src="https://webservices.uees.edu.ec/formularios/v2/form-embed.js" data-programa-id="810" data-nivel-id="2" data-modalidad-id="1" data-height="900" data-container="form-81021" defer></script>
                                       </div>
                                    </div>
                                 </div>
                              </div>
                     ...
                     <div class="gdlr-core-pbf-column gdlr-core-column-30 gdlr-core-column-first" id="gdlr-core-column-8638">
                        <div class="gdlr-core-pbf-column-content-margin gdlr-core-js  gdlr-core-column-extend-left" data-sync-height="height-2" style="height: 860.461px;">
                           <div class="gdlr-core-pbf-background-wrap">
                              <div class="gdlr-core-pbf-background gdlr-core-parallax gdlr-core-js" style="background-image: url(../images/carreras/maestria-en-gerencia-en-servicios-de-salud-01.jpg); background-size: cover; background-position: center center; height: 875.969px; transform: translate(0px, -43.5328px);" data-parallax-speed="0.2"></div>
                           </div>
                              ...
                              <div class="gdlr-core-pbf-element">
                                 <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align">
                                    <div class="gdlr-core-text-box-item-content" style="font-size: 17px ;text-transform: none ;">
                                       <p>Formar profesionales competentes desde el ámbito gerencial y administrativo en Servicios de la Salud,
                                            ya sean de instituciones públicas, privadas, sociales o de inversión. Conocedores de competencias y
                                            habilidades gerenciales para liderar mandos medios y altos de los sistemas integrales de salud;
                                            acogiéndose a normas internacionales de gestión sanitaria, instrumentos de planificación y gestión de
                                            recursos, que le permita tomar decisiones con eficiencia y responsabilidad sobre la dirección de
                                            hospitales, clínicas y centros de salud.</p>
                                    </div>
                                 </div>
                              </div>
                           </div>
                  ...
                  <div class="gdlr-core-pbf-wrapper-container clearfix gdlr-core-container">
                                       ...
                                       <ul>
                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                                                <span class="gdlr-core-icon-list-content" style="font-size: 16px;">Desarrollar programas coherentes con una formulación, ejecución y control de la gestión de la salud en los centros hospitalarios.</span>
                                             </div>
                                          </li>
                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                                                <span class="gdlr-core-icon-list-content" style="font-size: 16px;">Reconocer e identificar con precisión el rol que ocupa la comunicación organizacional externa e interna,
                                                            y será capaz de desarrollar estrategias de comunicación como herramienta transversal que exige estar
                                                            presente en todo proceso y subsistema de las organizaciones.</span>
                                             </div>
                                          </li>
                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                                                <span class="gdlr-core-icon-list-content" style="font-size: 16px;">Comprender y desarrollar desde una visión crítica y analítica, propuestas relativas a los procesos de
                                                                salud; entendiéndose como procesos fundamentales que deben ser flexibles y cambiantes, dadas las
                                                                demandas del entorno y la naturaleza de la organización.</span>
                                             </div>
                                          </li> 
                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                                                <span class="gdlr-core-icon-list-content" style="font-size: 16px;">Diseñar, implementar y evaluar sistemas de gestión hospitalaria, desde una visión sistémica e integral
                                                                que utiliza las herramientas adecuadas para cada situación.</span>
                                             </div>
                                          </li> 
                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                                                <span class="gdlr-core-icon-list-content" style="font-size: 16px;">Analizar y diseñar funciones y procedimientos que permitan la planificación, organización, ejecución y
                                                    control del sistema de gestión clínica.</span>
                                             </div>
                                          </li> 
                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                                                <span class="gdlr-core-icon-list-content" style="font-size: 16px;">Dirigir equipos de trabajos multidisciplinarios, interculturales y autodirigidos.</span>
                                             </div>
                                          </li>                                         
                                       </ul>
                                    </div>
                     ...
                     <div class="gdlr-core-pbf-column gdlr-core-column-30" id="gdlr-core-column-36639">
                        <div class="gdlr-core-pbf-column-content-margin gdlr-core-js  gdlr-core-column-extend-right" data-sync-height="height-1" style="height: 653.976px;">
                           <div class="gdlr-core-pbf-background-wrap">
                              <div class="gdlr-core-pbf-background gdlr-core-parallax gdlr-core-js" style="background-image: url(../images/carreras/maestria-en-gerencia-en-servicios-de-salud-02.jpg); background-size: cover; background-position: center center; height: 710.762px; transform: translate(0px, -35.625px);" data-parallax-speed="0.2"></div>
                           </div>
                           <div class="gdlr-core-pbf-column-content clearfix gdlr-core-js  gdlr-core-sync-height-content"></div>
                        </div>
                     </div>
                           ...
                           <div class="gdlr-core-pbf-column-content clearfix gdlr-core-js ">
                              <div class="gdlr-core-pbf-element">
                                 <table style="width: 100%">
                                    ...
                                    <tr>
                                       <td>Comportamiento Organizacional y Recursos Humanos</td>
                                       <td>18</td>
                                    </tr>
                                    <tr style="background-color: #ffffff">
                                       <td >Administración de las Organizaciones y Sistemas de Información en Salud</td>
                                       <td>18</td>
                                    </tr>
                                    <tr>
                                       <td>Administración de Recursos Financieros</td>
                                       <td>18</td>
                                    </tr>
                                    <tr>
                                       <td>Gerencia Estratégica y Negociación</td>
                                       <td>18</td>
                                    </tr>
                                    <tr>
                                       <td>Gestión de Servicios Médicos y Calidad en Salud</td>
                                       <td>18</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                       <td>Gestión de los Servicios de la Salud</td>
                                       <td>18</td>
                                    </tr>
                                    <tr>
                                       <td>Gestión Clínica</td>
                                       <td>18</td>
                                    </tr>
                                    <tr>
                                       <td>Titulación</td>
