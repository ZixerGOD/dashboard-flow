...
<body class="home page-template-default page page-id-2039 gdlr-core-body woocommerce-no-js tribe-no-js kingster-body kingster-body-front kingster-full  kingster-with-sticky-navigation  kingster-blockquote-style-1 gdlr-core-link-to-lightbox">
   ...
   <div class="kingster-body-outer-wrapper ">
      <div class="kingster-body-wrapper clearfix  kingster-with-frame">
         ...
         <div class="kingster-page-title-wrap  kingster-style-custom kingster-left-align" style="background-image: url(../images/carreras/maestria-en-ensenanza-en-ingles-como-lengua-extranjera-top.jpg) ;">
            ...
            <div class="kingster-page-title-container kingster-container">
               <div class="kingster-page-title-content kingster-item-pdlr" style="padding-top: 200px ;padding-bottom: 80px ;">
                  ...
                  <h1 class="kingster-page-title" style="text-transform: none ;">Maestr&iacute;a en Enseñanza de Inglés Como Lengua Extranjera</h1>
               </div>
            </div>
         </div>
                           ...
                           <div class="gdlr-core-pbf-element">
                              <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align">
                                 <div class="gdlr-core-text-box-item-content" style="font-size: 16px ;text-transform: none ;">
                                    <p>La Maestría en Enseñanza de Inglés como Lengua Extranjera, profesionales con título de tercer nivel de
                                        grado, en cualquier campo amplio del conocimiento, debidamente registrados en la SENESCYT, con nivel
                                        de suciencia de inglés de B2 de acuerdo al marco común europeo.</p>
                                    <p><strong>Duraci&oacute;n De Programa:</strong> 12 Meses</p>
                                    <p><strong>Horario Sincr&oacute;nico: </strong> Sábado de 08:00 a 14:00 </p>
                                          ...
                                          <div class="gdlr-core-column-service-item gdlr-core-item-pdb  gdlr-core-left-align gdlr-core-column-service-icon-left gdlr-core-with-caption gdlr-core-item-pdlr" style="padding-bottom: 30px;">
                                             ...
                                             <div class="gdlr-core-column-service-content-wrapper">
                                                <div class="gdlr-core-column-service-title-wrap">
                                                   ...
                                                   <div class="gdlr-core-column-service-caption gdlr-core-info-font gdlr-core-skin-caption" style="font-size: 15px ;font-weight: 500 ;font-style: normal ;">Magíster en Enseñanza de Inglés como Lengua Extranjera</div>
                                                </div>
                                             </div>
                                          </div>
                                       </div>
                                          ...
                                          <div class="gdlr-core-column-service-item gdlr-core-item-pdb  gdlr-core-left-align gdlr-core-column-service-icon-left gdlr-core-with-caption gdlr-core-item-pdlr" style="padding-bottom: 30px;">
                                             ...
                                             <div class="gdlr-core-column-service-content-wrapper">
                                                <div class="gdlr-core-column-service-title-wrap">
                                                   ...
                                                   <div class="gdlr-core-column-service-caption gdlr-core-info-font gdlr-core-skin-caption" style="font-size: 15px ;font-weight: 500 ;font-style: normal ;">RPC-SO-09-No.174-2023</div>
                                                </div>
                                             </div>
                                          </div>
                                       </div>
                              ...
                              <div class="textwidget" style="box-shadow: 0 -6px 24px rgba(10, 10, 10,0.09); -moz-box-shadow: 0 -6px 24px rgba(10, 10, 10,0.09); -webkit-box-shadow: 0 -6px 24px rgba(10, 10, 10,0.09); background-color: #ffffff ;border-radius:  3px 3px ;-moz-border-radius:  3px 3px ;-webkit-border-radius:  3px 3px ;">
                                 <div class="gdlr-core-widget-box-shortcode " style="color: #821436 ;padding: 25px 5px;background-color: #ffffff ;">
                                    <div class="gdlr-core-widget-box-shortcode-content">
                                       ...
                                       <div class="gdlr-core-pbf-element">
                                          <iframe src="https://webservices.uees.edu.ec/formularios/formulario-web-postgrado.php?c=Maestria en Ensenanza de Ingles como Lengua Extranjera Online&m=Online&n=Postgrado" style="height:500px;width:100%;border:none;" title="Formulario Web"></iframe>
                                       </div>
                                    </div>
                                 </div>
                              </div>
                              ...
                              <div class="gdlr-core-pbf-element">
                                 <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align">
                                    <div class="gdlr-core-text-box-item-content" style="font-size: 17px ;text-transform: none ;">
                                       <p>El objetivo de la Maestría en Enseñanza de inglés como lengua extranjera es preparar a los estudiantes
                                            para convertirse en profesionales digitales, competentes y eficaces en la enseñanza de inglés como lengua
                                            extranjera, brindándoles las habilidades y conocimientos necesarios para enfrentar los desafíos de la
                                            enseñanza de inglés en una variedad de contextos educativos y culturales.</p>
                                    </div>
                                 </div>
                              </div>
                           </div>
                  ...
                  <div class="gdlr-core-pbf-wrapper-container clearfix gdlr-core-container">
                                       ...
                                       <ul>
                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                                                <span class="gdlr-core-icon-list-content" style="font-size: 16px;">Profesor de inglés en escuelas, universidades, centros de idiomas y otros entornos educativos.</span>
                                             </div>
                                          </li>
                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                                                <span class="gdlr-core-icon-list-content" style="font-size: 16px;">Diseñador y evaluador de programas de enseñanza de inglés, enfocados en el desarrollo de habilidades
                                                    lingüísticas y comunicativas en estudiantes.</span>
                                             </div>
                                          </li>
                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                                                <span class="gdlr-core-icon-list-content" style="font-size: 16px;">Especialista en evaluación y diagnóstico de niveles de competencia en inglés, diseñando y aplicando
                                                    exámenes de nivel y de certificación.</span>
                                             </div>
                                          </li> 
                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                                                <span class="gdlr-core-icon-list-content" style="font-size: 16px;">Investigador en el campo de la enseñanza de inglés como lengua extranjera, enfocado en el desarrollo
                                                de metodologías y herramientas didácticas efectivas para la enseñanza del inglés.</span>
                                             </div>
                                          </li>
                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                                                <span class="gdlr-core-icon-list-content" style="font-size: 16px;">Consultor en empresas especializadas en la enseñanza del inglés como lengua extranjera, brindando
                                                asesoría y capacitación a docentes y estudiantes.</span>
                                             </div>
                                          </li>
                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                                                <span class="gdlr-core-icon-list-content" style="font-size: 16px;">Capacitador en empresas, diseñando y desarrollando programas de formación de inglés para el
                                                    personal de empresas.</span>
                                             </div>
                                          </li> 
                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                                                <span class="gdlr-core-icon-list-content" style="font-size: 16px;">Director o coordinador de programas de enseñanza de inglés, liderando equipos de docentes y
                                                    supervisando el desarrollo de planes de estudios y recursos educativos.</span>
                                             </div>
                                          </li>                                  
                                       </ul>
                                    </div>
                     ...
                     <div class="gdlr-core-pbf-column gdlr-core-column-30" id="gdlr-core-column-36639">
                        <div class="gdlr-core-pbf-column-content-margin gdlr-core-js  gdlr-core-column-extend-right" data-sync-height="height-1" style="height: 653.976px;">
                           <div class="gdlr-core-pbf-background-wrap">
                              <div class="gdlr-core-pbf-background gdlr-core-parallax gdlr-core-js" style="background-image: url(../images/carreras/maestria-en-ensenanza-en-ingles-como-lengua-extranjera-02.jpg); background-size: cover; background-position: center center; height: 710.762px; transform: translate(0px, -35.625px);" data-parallax-speed="0.2"></div>
                           </div>
                           <div class="gdlr-core-pbf-column-content clearfix gdlr-core-js  gdlr-core-sync-height-content"></div>
                        </div>
                     </div>
                           ...
                           <div class="gdlr-core-pbf-column-content clearfix gdlr-core-js ">
                              <div class="gdlr-core-pbf-element">
                                 <table>
                                    ...
                                    <tr>
                                       <td>Teaching, Listening and Speaking</td>
                                       <td>12</td>
                                    </tr>
                                    <tr>
                                       <td>The Fundamentals of Grammatical Structures</td>
                                       <td>12</td>
                                    </tr>
                                    <tr>
                                       <td>Methodology and Bilinguals in TEFL</td>
                                       <td>12</td>
                                    </tr>
                                    <tr>
                                       <td>Teaching Reading and Writing</td>
                                       <td>12</td>
                                    </tr>
                                    <tr>
                                       <td>Education Management and Leadership</td>
                                       <td>12</td>
                                    </tr>
                                    <tr>
                                       <td>Assessment and Rubrics</td>
                                       <td>6</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                       <td>Individual differences in language learning</td>
                                       <td>12</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                       <td>Teaching English for specific purposes</td>
                                       <td>6</td>
                                    </tr>
                                    <tr>
