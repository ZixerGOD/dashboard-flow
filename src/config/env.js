...
const env = {
  ...
  WIDGET_SUBMIT_TOKEN: optional('WIDGET_SUBMIT_TOKEN', ''),
  WIDGET_CHALLENGE_SECRET: optional('WIDGET_CHALLENGE_SECRET', ''),
  WIDGET_CHALLENGE_TTL_SECONDS: optionalInt('WIDGET_CHALLENGE_TTL_SECONDS', 120),
  ...
  META_CAPI_TEST_EVENT_CODE: optional('META_CAPI_TEST_EVENT_CODE', ''),
